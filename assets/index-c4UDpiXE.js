...
`;function h6(){const e=R(l=>l.mode),{color:n}=R(l=>l.color),{bgColor:i,fontColor:a,mainBgColor:t}=R(l=>l.mode),r=pn();return o.jsxs(d6,{children:[o.jsx(u6,{style:{backgroundColor:n},onClick:()=>r(-1),children:"Retour"}),o.jsxs(g6,{children:[o.jsx(vg,{$bgColor:i,$fontColor:a,$mainBgColor:t,to:"/color",children:o.jsxs("div",{children:[o.jsx("img",{src:e.mode==="light"?rm:tm}),o.jsx("p",{children:"Couleur"})]})}),o.jsx(vg,{$bgColor:i,$fontColor:a,$mainBgColor:t,children:o.jsxs(p6,{children:[o.jsx("img",{src:e.mode==="light"?s6:c6}),o.jsx("p",{children:"Skin"})]})})]})]})}const m6=m.div`
    width: 93.8%;
    display: flex;
    justify-content: end;
    @media screen and (max-width: 560px){
...
`;function Rm(){const{bgColor:e,fontColor:n,mainBgColor:i}=R(l=>l.mode),{color:a}=R(l=>l.color),t=window.innerWidth<=560?"7vw":"2vw";let r=pn();return o.jsx(m6,{children:o.jsxs(f6,{$bgColor:e,children:[o.jsxs(v6,{$fontColor:n,$mainBgColor:i,children:[o.jsx(Uo,{color:a,width:t,height:t}),o.jsx(Z,{onClick:()=>r(-1),children:"Retour"})]}),o.jsx(w6,{to:"/",$mainBgColor:i,children:o.jsx(Jo,{color:a,mainBgColor:i,width:t,height:t})})]})})}const x6=m.div`
    display: flex;
    gap: 1vw;
    width: 94%;
    @media screen and (max-width: 560px){
...
`;function b6(){const{bgColor:e,fontColor:n,mainBgColor:i}=R(t=>t.mode),{color:a}=R(t=>t.color);return o.jsxs(x6,{children:[o.jsx(j6,{$bgColor:e,children:o.jsxs(R6,{$mainBgColor:i,$fontColor:n,children:[o.jsxs(y6,{$color:a,$fontColor:n,children:[o.jsxs("div",{children:[o.jsx("p",{children:"き"}),o.jsx("p",{children:"記"})]}),o.jsxs("div",{children:[o.jsx("p",{children:"じ"}),o.jsx("p",{children:"事"})]})]}),o.jsx("p",{children:"Nos articles"})]})}),o.jsx(k6,{$bgColor:e,children:o.jsxs(C6,{$mainBgColor:i,$fontColor:n,children:[o.jsx("p",{children:"Description"}),o.jsx("p",{children:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas vehicula nisi neque. Pellentesque finibus neque vitae odio viverra, nec tempor lorem viverra. Morbi facilisis facilisis tempor. Sed posuere fermentum ligula ut sodales. Pellentesque elementum volutpat nulla, eget fringilla lectus luctus sit amet. "})]})})]})}const P6=m.div`
    display: flex;
    flex-direction: column;
    align-items: center;
    gap: 2vw;
...
`;function $6(){return o.jsxs(P6,{children:[o.jsx(Rm,{}),o.jsx(b6,{}),o.jsx(L6,{children:ld.map(e=>o.jsx(od,{article:e},e.id))})]})}const K6=m.div`
    display: flex;
    width: 92%;
    padding: 1vw;
    background-color: ${e=>e.$bgColor};
