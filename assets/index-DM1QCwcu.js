...
`;function Es({filterJlpt:e}){const[n,i]=K.useState("N5"),a=s=>{const c=s.target.value;n===c?(i(""),e("")):(i(c),e(c))},{fontColor:t,mainBgColor:r}=x(s=>s.mode),{color:o}=x(s=>s.color);return l.jsxs(zy,{name:"jlpt",id:"jlpt",value:n,$mainBgColor:r,$fontColor:t,$color:o,children:[l.jsx("button",{value:"N5",onClick:a,children:"N5"}),l.jsx("button",{value:"N4",onClick:a,children:"N4"}),l.jsx("button",{value:"N3",onClick:a,children:"N3"}),l.jsx("button",{value:"N2",onClick:a,children:"N2"}),l.jsx("button",{value:"N1",onClick:a,children:"N1"})]})}Es.propTypes={filterJlpt:E.func.isRequired};const Ay=y.div`
display: flex;
gap: 0.6vw;
height: 100%;
min-width: calc(40% - 0.7vw);
...
`;function Fw(){const{bgColor:e,fontColor:n,mainBgColor:i}=x(T=>T.mode),{color:a}=x(T=>T.color),t=x(T=>T.dataChoice.hiragana),r=x(T=>T.dataChoice.katakana),o=x(T=>T.dataChoice.kanji),s=x(T=>T.dataChoice.vocabulaire),c=x(T=>T.dataChoice.nombres),u=ge();let d=pi();const f=x(T=>T.search.searchText),g=x(T=>T.search.jlptLevel),v=x(T=>T.search.kanaType),R=x(T=>T.mode),w=x(T=>T.search.vocabulaireCategorie),k=x(T=>T.parametersExercice.exerciceNumber),h=So.kanji.filter(T=>{var J,W;return(((J=T.Meaning)==null?void 0:J.toLowerCase().includes(f))||((W=T.SecondaryMeaning)==null?void 0:W.toLowerCase().includes(f)))&&(g===""||T.JLPTLevel===g)}).sort((T,J)=>{var q,ne,O,S,H,z,F,ce,Le,Je;const W=((q=T.Kanji)==null?void 0:q.toLowerCase().startsWith(f))||((ne=T.OnReading)==null?void 0:ne.some(N=>N.toLowerCase().startsWith(f)))||((O=T.KunReading)==null?void 0:O.some(N=>N.toLowerCase().startsWith(f)))||((S=T.Meaning)==null?void 0:S.toLowerCase().startsWith(f))||((H=T.SecondaryMeaning)==null?void 0:H.toLowerCase().startsWith(f)),Y=((z=J.Kanji)==null?void 0:z.toLowerCase().startsWith(f))||((F=J.OnReading)==null?void 0:F.some(N=>N.toLowerCase().startsWith(f)))||((ce=J.KunReading)==null?void 0:ce.some(N=>N.toLowerCase().startsWith(f)))||((Le=J.Meaning)==null?void 0:Le.toLowerCase().startsWith(f))||((Je=J.SecondaryMeaning)==null?void 0:Je.toLowerCase().startsWith(f));return W&&!Y?-1:!W&&Y?1:0}),p=[...be.Hiragana,...be.Dakuten,...be.Handakuten,...be.Combinaison].filter(T=>{var J,W,Y,q;return(((J=T.Hiragana)==null?void 0:J.toLowerCase().includes(f))||((W=T.Dakuten)==null?void 0:W.toLowerCase().includes(f))||((Y=T.Handakuten)==null?void 0:Y.toLowerCase().includes(f))||((q=T.Romaji)==null?void 0:q.toLowerCase().includes(f)))&&(v===""||T.Type===v)}).sort((T,J)=>{var q,ne,O,S,H,z,F,ce;const W=((q=T.Hiragana)==null?void 0:q.toLowerCase().startsWith(f))||((ne=T.Dakuten)==null?void 0:ne.toLowerCase().startsWith(f))||((O=T.Handakuten)==null?void 0:O.toLowerCase().startsWith(f))||((S=T.Romaji)==null?void 0:S.toLowerCase().startsWith(f)),Y=((H=J.Hiragana)==null?void 0:H.toLowerCase().startsWith(f))||((z=J.Dakuten)==null?void 0:z.toLowerCase().startsWith(f))||((F=J.Handakuten)==null?void 0:F.toLowerCase().startsWith(f))||((ce=J.Romaji)==null?void 0:ce.toLowerCase().startsWith(f));return W&&!Y?-1:!W&&Y?1:0}),m=[...$e.Katakana,...$e.Dakuten,...$e.Handakuten,...$e.Combinaison].filter(T=>{var J,W,Y,q;return(((J=T.Katakana)==null?void 0:J.toLowerCase().includes(f))||((W=T.Dakuten)==null?void 0:W.toLowerCase().includes(f))||((Y=T.Handakuten)==null?void 0:Y.toLowerCase().includes(f))||((q=T.Romaji)==null?void 0:q.toLowerCase().includes(f)))&&(v===""||T.Type===v)}).sort((T,J)=>{var q,ne,O,S,H,z,F,ce;const W=((q=T.Katakana)==null?void 0:q.toLowerCase().startsWith(f))||((ne=T.Dakuten)==null?void 0:ne.toLowerCase().startsWith(f))||((O=T.Handakuten)==null?void 0:O.toLowerCase().startsWith(f))||((S=T.Romaji)==null?void 0:S.toLowerCase().startsWith(f)),Y=((H=J.Katakana)==null?void 0:H.toLowerCase().startsWith(f))||((z=J.Dakuten)==null?void 0:z.toLowerCase().startsWith(f))||((F=J.Handakuten)==null?void 0:F.toLowerCase().startsWith(f))||((ce=J.Romaji)==null?void 0:ce.toLowerCase().startsWith(f));return W&&!Y?-1:!W&&Y?1:0}),j=Array.isArray(Mi.vocabulaire)?Mi.vocabulaire.filter(T=>{var J,W,Y,q;return(((J=T.kanji)==null?void 0:J.toLowerCase().includes(f))||((W=T.hiragana)==null?void 0:W.toLowerCase().includes(f))||((Y=T.francais)==null?void 0:Y.toLowerCase().includes(f))||((q=T.Romaji)==null?void 0:q.toLowerCase().includes(f)))&&(g===""||T.niveau===g)&&(w.length===0||w.includes(T.categorie))}).sort((T,J)=>{var q,ne,O,S,H,z,F,ce;const W=((q=T.kanji)==null?void 0:q.toLowerCase().startsWith(f))||((ne=T.hiragana)==null?void 0:ne.toLowerCase().startsWith(f))||((O=T.francais)==null?void 0:O.toLowerCase().startsWith(f))||((S=T.Romaji)==null?void 0:S.toLowerCase().startsWith(f)),Y=((H=J.kanji)==null?void 0:H.toLowerCase().startsWith(f))||((z=J.hiragana)==null?void 0:z.toLowerCase().startsWith(f))||((F=J.francais)==null?void 0:F.toLowerCase().startsWith(f))||((ce=J.Romaji)==null?void 0:ce.toLowerCase().startsWith(f));return W&&!Y?-1:!W&&Y?1:0}):[],P=()=>{document.getElementById("recherche").scrollIntoView({behavior:"smooth"})},C=(()=>{switch(u.pathname){case"/choisir-ses/Kanji":return{modeTitle:"Kanji"};case"/choisir-ses/Hiragana":return{modeTitle:"Hiragana"};case"/choisir-ses/Katakana":return{modeTitle:"Katakana"};case"/choisir-ses/Vocabulaire":return{modeTitle:"Vocabulaire"};case"/choisir-ses/Nombres":return{modeTitle:"Nombres"};default:return"Accueil"}})(),b=u.pathname;let _;switch(b){case"/choisir-ses/Hiragana":_=t.length;break;case"/choisir-ses/Katakana":_=r.length;break;case"/choisir-ses/Kanji":_=o.length;break;case"/choisir-ses/Vocabulaire":_=s.length;break;case"/choisir-ses/Nombres":_=c.length;break;default:_=0;break}const D=Ie(),Q=()=>{switch(u.pathname){case"/choisir-ses/Vocabulaire":D(O2());break;case"/choisir-ses/Hiragana":D(M2());break;case"/choisir-ses/Katakana":D(N2());break;case"/choisir-ses/Kanji":D($2());break;case"/choisir-ses/Nombres":D(S2());break}};return l.jsxs(Sw,{children:[l.jsx(_w,{onClick:()=>d(-1),$color:a,$mainBgColor:i,children:l.jsx("img",{src:R.mode==="light"?Rm:Nw})}),l.jsxs(Hw,{children:[l.jsxs(Jw,{$mainBgColor:i,$bgColor:e,$fontColor:n,$color:a,children:[l.jsxs("div",{children:[l.jsxs("p",{children:[C.modeTitle," sélectionnes"]}),l.jsx("button",{onClick:Q,children:"Vider"})]}),l.jsxs("div",{id:"selectionnes",children:[b==="/choisir-ses/Hiragana"&&t.map((T,J)=>l.jsx("p",{children:T.Nom==="Dakuten"?T.Dakuten:T.Nom==="Handakuten"?T.Handakuten:T.Hiragana},J)),b==="/choisir-ses/Katakana"&&r.map((T,J)=>l.jsx("p",{children:T.Nom==="Dakuten"?T.Dakuten:T.Nom==="Handakuten"?T.Handakuten:T.Katakana},J)),b==="/choisir-ses/Kanji"&&o.map((T,J)=>l.jsx("p",{children:T.Kanji},J)),b==="/choisir-ses/Vocabulaire"&&s.map((T,J)=>l.jsx("p",{children:T.kanji||T.hiragana},J)),b==="/choisir-ses/Nombres"&&c.map((T,J)=>l.jsx("p",{children:T.Nombre},J))]})]}),l.jsxs(Dw,{$mainBgColor:i,$bgColor:e,$fontColor:n,$color:a,children:[l.jsxs("span",{children:[" ",_,"/",k]}),l.jsxs("p",{children:[C.modeTitle," sélectionnes"]})]})]}),l.jsx(Pm,{}),u.pathname==="/choisir-ses/Kanji"&&l.jsx(Bc,{kanjiList:h}),u.pathname==="/choisir-ses/Hiragana"&&l.jsx(Ic,{hiraganaList:p}),u.pathname==="/choisir-ses/Katakana"&&l.jsx(Vc,{katakanaList:m}),u.pathname==="/choisir-ses/Vocabulaire"&&l.jsx(Wc,{vocabulaireList:j}),l.jsx(Mw,{children:l.jsx(Ew,{onClick:P,$mainBgColor:i,$color:a,children:l.jsx("img",{src:R.mode==="light"?xm:Cm})})})]})}const zw=y.nav`
    background-color: ${e=>e.$bgColor};
    color: ${e=>e.$fontColor};
    padding: 0.9vw;
    border-radius: 0.8vw;
