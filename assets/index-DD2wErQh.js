...
`;function em({isButtonClicked:e,onLinkClick:n}){const{bgColor:i,fontColor:a,mainBgColor:t}=P(c=>c.mode),{color:r}=P(c=>c.color),[o,s]=K.useState("flex");return K.useEffect(()=>{window.innerWidth<=560?s(e?"flex":"none"):s("flex")},[e]),l.jsxs(z2,{$bgColor:i,display:o,children:[l.jsxs(Da,{$mainBgColor:t,to:"/Hiragana",onClick:n,children:[l.jsx(Ja,{$color:r,children:"ひらがな"}),l.jsx(za,{$fontColor:a,children:"あ"}),l.jsx(Fa,{$fontColor:a,children:"hiragana"})]}),l.jsxs(Da,{$mainBgColor:t,to:"/Katakana",onClick:n,children:[l.jsx(Ja,{$color:r,children:"カタカナ"}),l.jsx(za,{$fontColor:a,children:"ア"}),l.jsx(Fa,{$fontColor:a,children:"katakana"})]}),l.jsxs(Da,{$mainBgColor:t,to:"/Kanji",onClick:n,children:[l.jsx(Ja,{$color:r,children:"かんじ"}),l.jsx(za,{$fontColor:a,children:"漢字"}),l.jsx(Fa,{$fontColor:a,children:"kanji"})]}),l.jsxs(Da,{$mainBgColor:t,to:"/Vocabulaire",onClick:n,children:[l.jsx(Ja,{$color:r,children:"ごい"}),l.jsx(za,{$fontColor:a,children:"語彙"}),l.jsx(Fa,{$fontColor:a,children:"Vocabulaire"})]}),l.jsxs(Da,{$mainBgColor:t,to:"/Nombres",onClick:n,children:[l.jsx(Ja,{$color:r,children:"ばんごう"}),l.jsx(za,{$fontColor:a,children:"番号"}),l.jsx(Fa,{$fontColor:a,children:"Nombres"})]})]})}em.propTypes={isButtonClicked:M.bool.isRequired,onLinkClick:M.func.isRequired};const F2=j.div`
    display: flex;
    flex-direction: column;
    background-color: ${e=>e.$bgColor};
    color: ${e=>e.$fontColor};
...
`;function uy(){return l.jsxs(dy,{children:[l.jsx(ba,{}),l.jsx(Jt,{}),l.jsx(Bt,{}),l.jsx(zt,{}),l.jsx(_t,{}),l.jsx(Ft,{}),l.jsx(At,{})]})}const gy=j.header`
    display: flex;
    flex-direction: column;
    gap: 1vw;
    margin-left: 3vw;
...
`;function py(){return l.jsxs(gy,{children:[l.jsx(ba,{}),l.jsx(Jt,{}),l.jsx(Bt,{}),l.jsx(zt,{}),l.jsx(_t,{}),l.jsx(Ft,{}),l.jsx(At,{})]})}const fy=j.div`
    display: flex;
    flex-wrap: wrap;
    gap: 1vw;
    width: calc(100% - 3vw);
...
`;function hy(){return l.jsxs(my,{children:[l.jsx(ba,{}),l.jsx(Jt,{}),l.jsx(Bt,{}),l.jsx(zt,{}),l.jsx(Km,{}),l.jsx(_t,{}),l.jsx(Ft,{}),l.jsx(At,{})]})}const vy=j.header`
    display: flex;
    flex-direction: column;
    gap: 1vw;
    margin-left: 3vw;
...
`;function wy(){return l.jsxs(vy,{children:[l.jsx(ba,{}),l.jsx(Jt,{}),l.jsx(Bt,{}),l.jsx(zt,{}),l.jsx(Km,{}),l.jsx(_t,{}),l.jsx(Ft,{}),l.jsx(At,{})]})}const Ry=j.header`
    display: flex;
    flex-direction: column;
    gap: 1vw;
    margin-left: 3vw;
...
`;function jy(){return l.jsxs(Ry,{children:[l.jsx(ba,{}),l.jsx(Jt,{}),l.jsx(Bt,{}),l.jsx(zt,{}),l.jsx(_t,{}),l.jsx(Ft,{}),l.jsx(At,{})]})}const yy=j.div`
    display: flex;
    gap: 1vw;
    width: calc(100% - 21vw);
    height: 23.4vw;
...
`;function Sm(){const{bgColor:e}=P(s=>s.mode),n=He(),i=ce(),a=s=>{n(Wc(s.toLowerCase()))},t=s=>{n(Bw(s))},r=s=>{n(Uc(s))},o=s=>{n(Iw(s))};return l.jsxs(Ey,{id:"recherche",children:[(i.pathname==="/Dictionnaire/Kanji"||i.pathname==="/choisir-ses/Kanji")&&l.jsxs(mr,{$bgColor:e,children:[l.jsx(Ya,{onSearchChange:a}),l.jsx(Fs,{filterJlpt:t})]}),(i.pathname==="/Dictionnaire/Vocabulaire"||i.pathname==="/choisir-ses/Vocabulaire")&&l.jsxs(Hy,{children:[l.jsxs(mr,{$bgColor:e,children:[l.jsx(Ya,{onSearchChange:a}),l.jsx(Fs,{filterJlpt:t})]}),l.jsx("div",{children:l.jsx($m,{filterVocabulaire:o})})]}),(i.pathname==="/Dictionnaire/Katakana"||i.pathname==="/Dictionnaire/Hiragana"||i.pathname==="/choisir-ses/Katakana"||i.pathname==="/choisir-ses/Hiragana")&&l.jsxs(mr,{$bgColor:e,children:[l.jsx(Ya,{onSearchChange:a}),l.jsx(Tm,{filterKana:r})]}),(i.pathname==="/Dictionnaire/Nombres"||i.pathname==="/choisir-ses/Nombres")&&l.jsx(mr,{$bgColor:e,children:l.jsx(Ya,{onSearchChange:a})})]})}const Dy=j.div`
    display: flex;
    flex-wrap: wrap;
    gap: 0.6vw;
    width: calc(100% - 3vw);
...
`,qu=(e,n)=>{const i=[e],a=n.filter(t=>t!==e);for(;i.length<4;){const t=Math.floor(Math.random()*a.length),r=a[t];i.includes(r)||i.push(r)}return i.sort(()=>.5-Math.random())};function W5(){const e=P(N=>N.parametersExercice.exerciceModeDeJeu),n=P(N=>N.parametersExercice.exerciceNumber),i=P(N=>N.dataChoice),a=P(N=>N.parametersExercice.exerciceTypeDeKana),t=P(N=>N.parametersExercice.exerciceTimerActive),r=P(N=>N.dataChoice.katakana),o=P(N=>N.dataChoice.hiragana),{bgColor:s}=P(N=>N.mode),[c,u]=K.useState([]),[d,p]=K.useState(0),[m,g]=K.useState(null),[R,y]=K.useState(0),k=K.useRef(null),h=K.useRef(null),f=He(),v=ce(),w=P(N=>N.parametersExercice.exerciceTimer),[x,C]=K.useState(w),{color:L}=P(N=>N.color),[T,F]=K.useState(1),[D,q]=K.useState(1),[nn,b]=K.useState(!1),[J,U]=K.useState(!1),Z=K.useCallback(N=>{q(z=>z+1),f(ur(D)),N===!0&&(q(1),f(ur(D)))},[q,f,D]),V=K.useCallback((N,z)=>{F($n=>$n+1),f(dr(T)),f(Uw(z)),N===!0&&(F(1),f(dr(T)))},[F,f,T]),S=K.useCallback(()=>{h.current&&clearInterval(h.current),y(0),t===!1&&(h.current=setInterval(()=>{y(N=>N+1)},1e3))},[t]),O=K.useCallback(()=>{h.current&&(clearInterval(h.current),h.current=null)},[]),H=K.useCallback(()=>{C(w),k.current&&k.current()},[w]),A=K.useCallback(()=>{if(t===!0){const N=c[d];setTimeout(()=>{d<c.length-1?(p(d+1),V(!1,N)):(V(!1,N),U(!0),f(Iu(R)),O())},900)}},[d,c,t,V,O,f,R]);K.useEffect(()=>{if(t===!0&&J===!1){const N=setInterval(()=>{C(z=>z<=1?(clearInterval(N),A(),setTimeout(()=>{C(w)},900),0):z-1)},1e3);return()=>clearInterval(N)}},[w,A,f,t,J]),K.useEffect(()=>{C(w)},[w]),K.useEffect(()=>{H&&H(w)},[H,w]);const _=K.useCallback(()=>{let N;if(v.pathname.includes("/Exercices/Kanji")?(S(),N=Bo.kanji):v.pathname.includes("/Exercices/Hiragana")?(S(),a==="normal"?N=be.Hiragana:a==="accents"?N=[...be.Dakuten,...be.Handakuten]:a==="combinaison"?N=be.Combinaison:a==="tout"&&(N=[...be.Hiragana,...be.Dakuten,...be.Handakuten,...be.Combinaison],e==="Choisir ses questions"&&(N=o.map(z=>z.affiche==="Hiragana"?{...z,Type:"Hiragana"}:z.affiche==="Accents"?{...z,Type:z.affiche==="Accents"?"Dakuten":"Handakuten"}:{...z,Type:"Combinaison"})))):v.pathname.includes("/Exercices/Vocabulaire")?(S(),N=Ei.vocabulaire):v.pathname.includes("/Exercices/Nombres")?(S(),N=Ei.nombres):v.pathname.includes("/Exercices/Katakana")&&(S(),a==="normal"?N=Te.Katakana:a==="accents"?N=[...Te.Dakuten,...Te.Handakuten]:a==="combinaison"?N=Te.Combinaison:a==="tout"?(N=[...Te.Katakana,...Te.Dakuten,...Te.Handakuten,...Te.Combinaison],e==="Choisir ses questions"&&(N=r.map(z=>z.affiche==="Katakana"?{...z,Type:"Katakana"}:z.affiche==="Accents"?{...z,Type:z.affiche==="Accents"?"Dakuten":"Handakuten"}:{...z,Type:"Combinaison"}))):O()),N){let z=[];if(e==="Aléatoire")z=N.sort(()=>.5-Math.random()).slice(0,n);else if(e==="N5")z=N.filter(G=>G.JLPTLevel==="N5").sort(()=>.5-Math.random()).slice(0,n);else if(e==="Choisir ses questions"){if(f(Qc("tout")),v.pathname.includes("/Exercices/Kanji")&&i.kanji){const G=i.kanji.map(X=>X.Kanji);z=N.filter(X=>G.includes(X.Kanji)).sort(()=>.5-Math.random()).slice(0,n),console.log(z)}else if(v.pathname.includes("/Exercices/Vocabulaire")&&i.vocabulaire){const G=i.vocabulaire.map(X=>X.francais);z=N.filter(X=>G.includes(X.francais)).sort(()=>.5-Math.random()).slice(0,n)}else if(v.pathname.includes("/Exercices/Hiragana")&&i.hiragana){const G=i.hiragana.map(X=>X.hiragana);z=N.filter(X=>G.includes(X.hiragana)).sort(()=>.5-Math.random()).slice(0,n)}else if(v.pathname.includes("/Exercices/Katakana")&&i.katakana){const G=i.katakana.map(X=>X.Katakana);z=N.filter(X=>G.includes(X.Katakana)).sort(()=>.5-Math.random()).slice(0,n)}else if(v.pathname.includes("/Exercices/Nombres")&&i.nombre){const G=i.nombre.map(X=>X.francais);z=N.filter(X=>G.includes(X.francais)).sort(()=>.5-Math.random()).slice(0,n)}}const $n=z.map(G=>{if(v.pathname.includes("/Exercices/Hiragana")||v.pathname.includes("/Exercices/Katakana")){const X=G.Romaji,Bn=qu(X,N.map(Ie=>Ie.Romaji));return{...G,options:Bn,id:G.id.toString()}}else{const X=G.Meaning||G.francais,Bn=qu(X,N.map(Ie=>Ie.Meaning||Ie.francais));return{...G,options:Bn,id:G.id.toString()}}});u($n),p(0)}},[e,n,i,a,v.pathname,S,O,f,r,o]);K.useEffect(()=>{const N=()=>{f(dr(0)),f(ur(0))};_(),O(),S(),N()},[_,O,S,f]);const de=N=>{g(N);const z=c[d];N?(Z(),b(!0),O()):(V(!1,z),b(!0),O()),setTimeout(()=>{d<c.length-1?(p(d+1),g(null)):(f(Iu(R)),U(!0)),g(null),b(!1),C(w)},900),k.current&&k.current()},ne=()=>{de(!1)},De=()=>{Z(!0),V(!0),f(ur(0)),f(dr(0)),_(),O(),S(),U(!1),f(Qw()),C(w)};return l.jsxs(A5,{children:[J===!0?l.jsx(Dm,{onReload:De}):null,l.jsxs(B5,{$bgColor:s,children:[t===!0&&l.jsx(V5,{$color:L,children:l.jsxs("p",{children:[x,l.jsx("span",{children:"s"})]})}),c&&c.length>0?l.jsxs(I5,{children:[l.jsx(Mm,{question:c[d],isCorrect:m}),l.jsx(Em,{question:c[d],options:c[d].options,onAnswer:de,isCorrect:m,buttonDisabled:nn})]},c[d].id):l.jsx("p",{children:"Aucune question disponible."})]}),l.jsx(Hm,{onReload:De,onSkip:ne,buttonDisabled:nn})]})}const U5=j.div`
    width: 6vw;
    border-radius: 0.8vw;
    padding: 1vw;
    height: 60.3vh;
