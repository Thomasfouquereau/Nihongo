...
`,br=({difficulte:e,icon:n,children:i})=>{const a=Ie(),{fontColor:t,mainBgColor:r}=P(c=>c.mode),{color:o}=P(c=>c.color),s=()=>{a(x2(e))};return l.jsxs(ij,{$mainBgColor:r,$fontColor:t,onClick:s,children:[l.jsxs(aj,{children:[l.jsx("img",{src:n}),l.jsx("span",{children:e})]}),l.jsx(tj,{$mainBgColor:r,$color:o,children:i})]})};br.propTypes={difficulte:M.string.isRequired,icon:M.string.isRequired,children:M.node};function Dt(){const{bgColor:e,fontColor:n,mainBgColor:i}=P(g=>g.mode),{color:a}=P(g=>g.color),t=Ie(),[r,o]=K.useState(P(g=>g.parametersExercice.exerciceTimer)),[s,c]=K.useState(P(g=>g.parametersExercice.exerciceTimerActive));K.useEffect(()=>{t(P2(r))},[r,t]);const d=()=>{c(!s),t(C2(!s))},u=()=>{r<15&&o(r+1)},p=()=>{r>1&&o(r-1)},m=window.innerWidth<560?"15vw":"5vw";return l.jsxs(Iw,{id:"SectionDifficulte",children:[l.jsx(Vw,{$bgColor:e,children:l.jsxs(Ww,{$mainBgColor:i,$fontColor:n,children:[l.jsx("span",{children:"Temps par question"}),l.jsxs(Uw,{$color:a,children:[l.jsx("button",{onClick:u,children:l.jsx(Ms,{width:m,height:m,color:a})}),l.jsxs("p",{children:[r,l.jsx("span",{children:"S"})]}),l.jsx("button",{onClick:p,children:l.jsx(Ms,{width:m,height:m,color:a})})]}),l.jsx(Qw,{onClick:d,$color:a,children:s?"Activer":"Désactiver"})]})}),l.jsxs(qw,{$bgColor:e,children:[l.jsxs(Zw,{children:[l.jsx(Yw,{$mainBgColor:i,$fontColor:n,children:"Difficulté"}),l.jsxs(Gw,{$color:a,children:[l.jsxs(Xw,{children:[l.jsx("span",{children:"こん"}),l.jsx("span",{children:"なん"})]}),l.jsxs(ej,{children:[l.jsx("span",{children:"困"}),l.jsx("span",{children:"難"})]})]})]}),l.jsxs(nj,{children:[l.jsxs(br,{difficulte:"Débutant",icon:Fw,children:[l.jsx("span",{children:"Hiragana/Katakana"}),l.jsx("span",{children:"Rōmaji"})]}),l.jsx(br,{difficulte:"Intermédiaire",icon:Aw,children:l.jsx("span",{children:"Hiragana/Katakana"})}),l.jsx(br,{difficulte:"Confirmer",icon:Bw})]})]})]})}const rj=j.div`
    display: flex;
    width: calc(100% - 3vw);
    margin-right: 3vw;
    gap: 1vw;
...
`;function Ft(){const{bgColor:e,fontColor:n,mainBgColor:i}=P(w=>w.mode),{color:a}=P(w=>w.color),t=P(w=>w.parametersExercice.exerciceDifficulté),r=P(w=>w.parametersExercice.exerciceModeDeJeu),o=P(w=>w.parametersExercice.exerciceNumber),s=ge(),c=fi(),u=(()=>{switch(s.pathname){case"/Kanji":return{modeTitle:"Kanji"};case"/Hiragana":return{modeTitle:"Hiragana"};case"/Katakana":return{modeTitle:"Katakana"};case"/Vocabulaire":return{modeTitle:"Vocabulaire"};case"/Nombres":return{modeTitle:"Nombres"};default:return{modeTitle:"Accueil"}}})(),p=P(w=>w.parametersExercice.exerciceModeDeJeu),m=P(w=>w.parametersExercice.exerciceNumber),g=P(w=>w.parametersExercice.exerciceDifficulté),[R,y]=K.useState(!1);K.useEffect(()=>{R&&c(`/Exercices/${u.modeTitle}`)},[R,c,u.modeTitle]);const x=(w,k)=>{document.querySelector(w).style.display=k?"flex":"none"},v=()=>{const w=p==="",k=m===0,C=g==="";w||k||C?(document.querySelector(".Alert").style.display="block",y(!1),x(".AlertMode",w),x(".AlertNbQuestion",k),x(".AlertDifficulte",C)):y(!0)},f=()=>{document.querySelector(".Alert").style.display="none",x(".AlertMode",!1),x(".AlertNbQuestion",!1),x(".AlertDifficulte",!1)},h=w=>()=>{const k=document.getElementById(`Section${w}`);k?(document.querySelector(".Alert").style.display="none",window.innerWidth<=560?k.scrollIntoView({behavior:"smooth",block:"start"}):k.scrollIntoView({behavior:"smooth",block:"center"})):console.error(`Element not found: #Section${w}`)};return l.jsxs(hj,{$bgColor:e,children:[l.jsx(Cj,{className:"Alert",children:l.jsxs(Lj,{children:[l.jsx(Kj,{onClick:f,$color:a,children:l.jsx("img",{src:Rm})}),l.jsxs(kl,{onClick:h("Difficulte"),className:"AlertDifficulte",$bgColor:e,$mainBgColor:i,$color:a,$fontColor:n,children:[l.jsxs("h1",{children:["Selectionner une ",l.jsx("span",{children:"difficulté"})]}),l.jsxs("div",{children:[l.jsx("p",{children:"Selon la difficulté choisie, plus ou moins d'aide vous sera proposée"}),l.jsx("span",{})]})]}),l.jsxs(kl,{onClick:h("NombreDeQuestions"),className:"AlertNbQuestion",$bgColor:e,$mainBgColor:i,$color:a,$fontColor:n,children:[l.jsxs("h1",{children:["Selectionner un ",l.jsx("span",{children:"nombre de questions"})]}),l.jsxs("div",{children:[l.jsx("p",{children:"Sélectionner le nombre de questions qui vous sera posée lors de l'exercice"}),l.jsx("span",{})]})]}),l.jsxs(kl,{onClick:h("ModeDeJeu"),className:"AlertMode",$bgColor:e,$mainBgColor:i,$color:a,$fontColor:n,children:[l.jsxs("h1",{children:["Selectionner un ",l.jsx("span",{children:"mode de jeu"})]}),l.jsxs("div",{children:[l.jsx("p",{children:"Le mode de jeu influencera les questions qui vous seront posées lors de l'exercice"}),l.jsx("span",{})]})]})]})}),l.jsxs(vj,{$color:a,onClick:v,children:[l.jsx(Rj,{children:"Commencer"}),l.jsx("img",{src:mj}),l.jsxs(wj,{children:[l.jsx("span",{children:"はじ"}),l.jsxs(jj,{children:[l.jsx("span",{children:"始"}),l.jsx("span",{children:"める"})]})]})]}),l.jsxs(yj,{children:[l.jsxs(xj,{$fontColor:n,$mainBgColor:i,$color:a,children:[l.jsx("span",{children:"Mode de jeu"}),l.jsx("span",{children:r})]}),l.jsxs(kj,{$fontColor:n,$mainBgColor:i,$color:a,children:[l.jsx("span",{children:"Difficulté"}),l.jsx("span",{children:t})]})]}),l.jsxs(Pj,{$fontColor:n,$mainBgColor:i,$color:a,children:[l.jsxs("span",{children:["Nombre de ",u.modeTitle.replace("'","&apos;")," dans l'exercice"]}),l.jsx("span",{children:o})]})]})}const Tj=j.header`
    display: flex;
    flex-direction: column;
    gap: 1vw;
    margin-left: 3vw;
...
`;function xm({filterVocabulaire:e}){const{bgColor:n,fontColor:i,mainBgColor:a}=P(u=>u.mode),{color:t}=P(u=>u.color),[r,o]=K.useState("Tous"),s=Wj.filtres.map(u=>u.filtre),c=u=>{const p=u.target.value;r===p?(o(""),e("")):(o(p),e(p))},d=()=>{const u=document.querySelector(".VocabulaireFilterButtonContainer"),p=document.querySelector(".VocabulaireFilterContainer"),m=document.querySelector(".MoreButtonIcon");window.innerWidth>560?u&&p&&(u.style.overflow==="visible"?(u.style.overflow="hidden",p.style.maxHeight="8.3vw",m.style.transform="rotate(0deg)"):(u.style.overflow="visible",p.style.maxHeight="100%",m.style.transform="rotate(180deg)")):u&&p&&(u.style.overflow==="visible"?(u.style.overflow="hidden",u.style.maxHeight="50vw",m.style.transform="rotate(0deg)"):(u.style.overflow="visible",u.style.maxHeight="100%",m.style.transform="rotate(180deg)"))};return l.jsxs(Qj,{className:"VocabulaireFilterContainer",$bgColor:n,children:[l.jsx(qj,{$fontColor:i,$mainBgColor:a,children:"Filtre"}),l.jsxs(Zj,{$mainBgColor:a,children:[l.jsx(Yj,{className:"VocabulaireFilterButtonContainer",$mainBgColor:a,$color:t,onChange:c,value:r,children:s.map(u=>l.jsx("button",{value:u,onClick:c,children:u},u))}),l.jsx(Gj,{$color:t,onClick:d,children:l.jsx("img",{className:"MoreButtonIcon",src:Uj,alt:"More"})})]})]})}xm.propTypes={filterVocabulaire:M.func.isRequired};const Xj=j.div`
    display: flex;
    flex-direction: column;
    gap: 1vw;
    @media screen and (max-width: 560px) {
...
`,Qy=j.span`
    ...
    margin: 0;
    border-radius: 0.5vw;
`;function qy(){const{bgColor:e,fontColor:n,mainBgColor:i}=P(d=>d.mode),{color:a}=P(d=>d.color),[t,r]=K.useState("日本"),[o,s]=K.useState(new Date().toLocaleTimeString("ja-JP",{timeZone:"Asia/Tokyo"}));K.useEffect(()=>{const d=setInterval(()=>{s(new Date().toLocaleTimeString(t==="フランス"?"fr-FR":"ja-JP",{timeZone:t==="フランス"?"Europe/Paris":"Asia/Tokyo",hour:"2-digit",minute:"2-digit"}))},10);return()=>clearInterval(d)},[t]);const c=d=>{r(d==="France"?"フランス":"日本")};return l.jsxs(Vy,{$bgColor:e,$fontColor:n,children:[l.jsxs(Wy,{$mainBgColor:i,$fontColor:n,children:[l.jsx("button",{onClick:()=>c("France"),style:{backgroundColor:t==="フランス"?a:i},children:"France"}),l.jsx("button",{onClick:()=>c("Japon"),style:{backgroundColor:t==="日本"?a:i},children:"Japon"})]}),l.jsx(Uy,{$mainBgColor:i,children:t}),l.jsx(Qy,{$color:a,$mainBgColor:i,children:o})]})}const Zy=j.button`
    display: none;
    @media screen and (max-width: 560px) {
        background-color: ${e=>e.$color};
        color: #F7F7F2;
...
`;function x5(){const{bgColor:e}=P(n=>n.mode);return l.jsxs(j5,{$bgColor:e,children:[l.jsx(R5,{}),l.jsxs(y5,{children:[l.jsx(Id,{}),l.jsx(Id,{})]})]})}const k5=j.div`
    display: flex;
    justify-content: center;
    align-items: center;
    gap: 0.5vw;
