...
`,ly=y.span`
    ...
    text-align: center;
    font-weight: 700;
`;function _t(){const{bgColor:e,fontColor:n,mainBgColor:i}=x(f=>f.mode),{color:a}=x(f=>f.color),t=Ie(),r=ge(),s=(()=>{switch(r.pathname){case"/Kanji":return{modeTitle:"Kanji"};case"/Hiragana":return{modeTitle:"Hiragana"};case"/Katakana":return{modeTitle:"Katakana"};case"/Vocabulaire":return{modeTitle:"Vocabulaire"};case"/Nombres":return{modeTitle:"Nombres"};default:return"Accueil"}})(),c=pi(),u=f=>{t(Pd(f))},d=f=>{t(Pd(f)),c(`/choisir-ses/${s.modeTitle}`),window.scrollTo(0,0)};return l.jsxs(ay,{id:"SectionModeDeJeu",children:[l.jsx(yl,{$bgColor:e,onClick:()=>u("Aléatoire"),children:l.jsxs(kl,{$mainBgColor:i,$fontColor:n,children:[l.jsx(wl,{$color:a,children:"Mode de jeu"}),l.jsxs(ty,{children:[l.jsx("span",{children:"ランダム"}),l.jsx("span",{children:"Aléatoire"})]})]})}),r.pathname.includes("/Vocabulaire")||r.pathname.includes("/Kanji")?l.jsx(yl,{$bgColor:e,onClick:()=>u("N5"),children:l.jsxs(kl,{$mainBgColor:i,$fontColor:n,children:[l.jsx(wl,{$color:a,children:"Mode de jeu"}),l.jsx(ry,{children:"N5"}),l.jsx(oy,{children:"JLPT"})]})}):null,l.jsx(yl,{$bgColor:e,onClick:()=>d("Choisir ses questions"),children:l.jsxs(kl,{$mainBgColor:i,$fontColor:n,children:[l.jsx(wl,{$color:a,children:"Mode de jeu"}),l.jsxs(ly,{children:["Choisir ses ",s.modeTitle]})]})})]})}const sy=y.div`
    display: flex;
    width: calc(100% - 5vw);
    height: 20vw;
    padding: 1vw;
...
`,Wk=y.span`
    ...
    margin: 0;
    border-radius: 0.5vw;
`;function Uk(){const{bgColor:e,fontColor:n,mainBgColor:i}=x(u=>u.mode),{color:a}=x(u=>u.color),[t,r]=K.useState("日本"),[o,s]=K.useState(new Date().toLocaleTimeString("ja-JP",{timeZone:"Asia/Tokyo"}));K.useEffect(()=>{const u=setInterval(()=>{s(new Date().toLocaleTimeString(t==="フランス"?"fr-FR":"ja-JP",{timeZone:t==="フランス"?"Europe/Paris":"Asia/Tokyo",hour:"2-digit",minute:"2-digit"}))},10);return()=>clearInterval(u)},[t]);const c=u=>{r(u==="France"?"フランス":"日本")};return l.jsxs(Bk,{$bgColor:e,$fontColor:n,children:[l.jsxs(Ik,{$mainBgColor:i,$fontColor:n,children:[l.jsx("button",{onClick:()=>c("France"),style:{backgroundColor:t==="フランス"?a:i},children:"France"}),l.jsx("button",{onClick:()=>c("Japon"),style:{backgroundColor:t==="日本"?a:i},children:"Japon"})]}),l.jsx(Vk,{$mainBgColor:i,children:t}),l.jsx(Wk,{$color:a,$mainBgColor:i,children:o})]})}const Qk=y.div`  
    display: flex;
    flex-direction: column;
    position: absolute;
    right: 3vw;
...
`;function bm({onReload:e}){const n=pi(),{bgColor:i,fontColor:a,mainBgColor:t}=x(p=>p.mode),{color:r}=x(p=>p.color),o=x(p=>p.parametersExercice.exerciceModeDeJeu),s=x(p=>p.parametersExercice.exerciceNumber),c=x(p=>p.parametersExercice.exerciceDifficulté),u=x(p=>p.parametersExercice.exerciceTimer),d=x(p=>p.exercice.totalTimer),f=x(p=>p.parametersExercice.exerciceTimerActive),g=x(p=>p.exercice.totalfaute),v=x(p=>p.exercice.questionsIncorrectes),[R,k]=K.useState(null),h=(p=>{const m=Math.floor(p/60),j=p%60,P=m.toString().padStart(2,"0"),L=j.toString().padStart(2,"0");return`${P}:${L}`})(d);return v?l.jsxs(ew,{$mainBgColor:t,children:[l.jsxs(nw,{$bgColor:i,children:[l.jsxs(iw,{$mainBgColor:t,$fontColor:a,$color:r,children:[l.jsx("p",{children:"Difficulté"}),l.jsx("p",{children:c})]}),l.jsxs(aw,{$mainBgColor:t,$fontColor:a,$color:r,children:[l.jsx("p",{children:"Nombre de Kanji "}),l.jsx("p",{children:s})]}),l.jsxs(tw,{$mainBgColor:t,$fontColor:a,$color:r,children:[l.jsx("p",{children:"Mode de jeu"}),l.jsx("p",{children:o})]}),l.jsx(rw,{$mainBgColor:t,$fontColor:a,$color:r,children:R&&l.jsxs("div",{children:[l.jsx("h3",{children:R.kanji||R.Dakuten||R.Handakuten||R.hiragana||R.Hiragana||R.Katakana||R.Kanji}),l.jsxs("div",{children:[R.Romaji&&l.jsxs("p",{children:[l.jsx("span",{children:"Romaji "})," ",R.Romaji]}),R.francais&&l.jsxs("p",{children:[l.jsx("span",{children:"Francais "})," ",R.francais]}),R.hiragana&&l.jsxs("p",{children:[l.jsx("span",{children:"Hiragana "})," ",R.hiragana]}),R.OnPrincipalReading&&l.jsxs("p",{children:[l.jsx("span",{children:"On "})," ",R.OnPrincipalReading]}),R.KunPrincipalReading&&l.jsxs("p",{children:[l.jsx("span",{children:"Kun "})," ",R.KunPrincipalReading]}),R.Meaning&&l.jsxs("p",{children:[l.jsx("span",{children:"Francais "})," ",R.Meaning]})]})]})}),l.jsx(ow,{$mainBgColor:t,$fontColor:a,$color:r,children:l.jsx("div",{children:v.length>0?v.filter(Boolean).map((p,m)=>l.jsx("p",{onMouseEnter:()=>k(p),children:p.kanji||(p.Nom==="Handakuten"?p.Handakuten:p.Nom==="Dakuten"?p.Dakuten:p.hiragana||p.Hiragana||p.Katakana||p.Kanji)},m)):l.jsx("p",{children:"pas de faute"})})}),l.jsxs(lw,{$mainBgColor:t,$fontColor:a,$color:r,children:[l.jsx("p",{children:"Erreur"}),l.jsx("p",{children:g})]}),l.jsx(sw,{$mainBgColor:t,$fontColor:a,$color:r,children:l.jsxs("p",{children:[f===!1?h:u,l.jsx("span",{children:"s"})]})}),l.jsx(cw,{$mainBgColor:t,$fontColor:a,$color:r,$bgColor:i,children:l.jsx("div",{})})]}),l.jsxs(uw,{$mainBgColor:t,$fontColor:a,$color:r,$bgColor:i,children:[l.jsxs("button",{onClick:e,children:[" ",l.jsx(Uc,{color:r,children:" "})]}),l.jsx("button",{onClick:()=>{e(),n(-1)},children:"Terminer"})]})]}):l.jsx("div",{children:"Loading..."})}bm.propTypes={onReload:E.func.isRequired};const dw=y.div`
    display: flex;
    flex-direction: column;
    align-items: center;
    width: 100%;
...
`;function jw(){const{bgColor:e,fontColor:n,mainBgColor:i}=x(s=>s.mode),a=x(s=>s.exercice.totalfaute),t=x(s=>s.exercice.totalreussite),r=x(s=>s.parametersExercice.exerciceNumber),o=t+a;return l.jsxs(Rw,{$mainBgColor:i,$bgColor:e,$fontColor:n,children:[l.jsx("p",{children:t}),l.jsxs("p",{children:[o,"/",r]}),l.jsx("p",{children:a})]})}function yw(){return l.jsx("div",{})}const kw=y.div`
    display: flex;
    align-items: center;
