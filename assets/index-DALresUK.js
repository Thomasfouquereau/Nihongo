...
`;function Es({filterJlpt:e}){const[n,i]=K.useState("N5"),a=s=>{const c=s.target.value;n===c?(i(""),e("")):(i(c),e(c))},{fontColor:t,mainBgColor:r}=P(s=>s.mode),{color:o}=P(s=>s.color);return l.jsxs(Bw,{name:"jlpt",id:"jlpt",value:n,$mainBgColor:r,$fontColor:t,$color:o,children:[l.jsx("button",{value:"N5",onClick:a,children:"N5"}),l.jsx("button",{value:"N4",onClick:a,children:"N4"}),l.jsx("button",{value:"N3",onClick:a,children:"N3"}),l.jsx("button",{value:"N2",onClick:a,children:"N2"}),l.jsx("button",{value:"N1",onClick:a,children:"N1"})]})}Es.propTypes={filterJlpt:E.func.isRequired};const Iw=w.div`
    display: flex;
    gap: 0.6vw;
    height: 100%;
    min-width: calc(40% - 0.7vw);
...
`;function Lm({isButtonClicked:e}){const{bgColor:n,fontColor:i,mainBgColor:a}=P(s=>s.mode),{color:t}=P(s=>s.color),[r,o]=K.useState("flex");return K.useEffect(()=>{window.innerWidth<=560?o(e?"flex":"none"):o("flex")},[e]),l.jsxs(Iy,{$bgColor:n,display:r,children:[l.jsxs(_a,{$mainBgColor:a,to:"/Hiragana",children:[l.jsx(Fa,{$color:t,children:"ひらがな"}),l.jsx(Aa,{$fontColor:i,children:"あ"}),l.jsx(Ba,{$fontColor:i,children:"hiragana"})]}),l.jsxs(_a,{$mainBgColor:a,to:"/Katakana",children:[l.jsx(Fa,{$color:t,children:"カタカナ"}),l.jsx(Aa,{$fontColor:i,children:"ア"}),l.jsx(Ba,{$fontColor:i,children:"katakana"})]}),l.jsxs(_a,{$mainBgColor:a,to:"/Kanji",children:[l.jsx(Fa,{$color:t,children:"かんじ"}),l.jsx(Aa,{$fontColor:i,children:"漢字"}),l.jsx(Ba,{$fontColor:i,children:"kanji"})]}),l.jsxs(_a,{$mainBgColor:a,to:"/Vocabulaire",children:[l.jsx(Fa,{$color:t,children:"ごい"}),l.jsx(Aa,{$fontColor:i,children:"語彙"}),l.jsx(Ba,{$fontColor:i,children:"Vocabulaire"})]}),l.jsxs(_a,{$mainBgColor:a,to:"/Nombres",children:[l.jsx(Fa,{$color:t,children:"ばんごう"}),l.jsx(Aa,{$fontColor:i,children:"番号"}),l.jsx(Ba,{$fontColor:i,children:"Nombres"})]})]})}Lm.propTypes={isButtonClicked:E.bool.isRequired};const Vy=w.div`
    display: flex;
    flex-direction: column;
    background-color: ${e=>e.$bgColor};
    color: ${e=>e.$fontColor};
...
`;function qy(){const{bgColor:e,fontColor:n,mainBgColor:i}=P(d=>d.mode),{color:a}=P(d=>d.color),[t,r]=K.useState("日本"),[o,s]=K.useState(new Date().toLocaleTimeString("ja-JP",{timeZone:"Asia/Tokyo"}));K.useEffect(()=>{const d=setInterval(()=>{s(new Date().toLocaleTimeString(t==="フランス"?"fr-FR":"ja-JP",{timeZone:t==="フランス"?"Europe/Paris":"Asia/Tokyo",hour:"2-digit",minute:"2-digit"}))},10);return()=>clearInterval(d)},[t]);const c=d=>{r(d==="France"?"フランス":"日本")};return l.jsxs(Vy,{$bgColor:e,$fontColor:n,children:[l.jsxs(Wy,{$mainBgColor:i,$fontColor:n,children:[l.jsx("button",{onClick:()=>c("France"),style:{backgroundColor:t==="フランス"?a:i},children:"France"}),l.jsx("button",{onClick:()=>c("Japon"),style:{backgroundColor:t==="日本"?a:i},children:"Japon"})]}),l.jsx(Uy,{$mainBgColor:i,children:t}),l.jsx(Qy,{$color:a,$mainBgColor:i,children:o})]})}const Zy=w.button`
   ...
   `;function Km({onButtonClick:e}){const{color:n}=P(a=>a.color),{mainBgColor:i}=P(a=>a.mode);return l.jsx(Zy,{$color:n,$bgColor:i,onClick:e,children:"Menu"})}Km.propTypes={onButtonClick:E.func.isRequired};const Yy=w.div`
    display: flex;
    flex-direction: column;
    position: absolute;
    right: 3vw;
...
`;function Gy(){const[e,n]=K.useState(!1),i=()=>{n(!e),console.log("Button clicked!",e)};return l.jsxs(Yy,{clicked:e?"true":void 0,children:[l.jsx(Lm,{isButtonClicked:e}),l.jsx(qy,{}),l.jsx(Km,{onButtonClick:i})]})}const Xy=w.div`
    display: flex;
    justify-content: center;
    align-items: center;
    width: 100%;
...
`;function $m({onReload:e,onSkip:n,buttonDisabled:i}){const{bgColor:a,mainBgColor:t,fontColor:r}=P(c=>c.mode),{color:o}=P(c=>c.color),s=fi();return l.jsxs(i5,{$color:o,$bgColor:a,$mainBgColor:t,$fontColor:r,children:[l.jsx("button",{onClick:()=>{e(),s(-1)},children:"Retour"}),l.jsx("button",{onClick:n,disabled:i,children:"Passer"}),l.jsx("button",{onClick:e,children:l.jsx(Uc,{color:o,children:" "})})]})}$m.propTypes={onReload:E.func.isRequired,onSkip:E.func.isRequired,buttonDisabled:E.bool};const a5=w.div`
    display: flex;
    flex-direction: column;
    align-items: center;
    justify-content: center;
