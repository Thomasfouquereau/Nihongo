...
`,qy=j.span`
    ...
    margin: 0;
    border-radius: 0.5vw;
`;function Zy(){const{bgColor:e,fontColor:n,mainBgColor:i}=P(u=>u.mode),{color:a}=P(u=>u.color),[t,r]=K.useState("日本"),[o,s]=K.useState(new Date().toLocaleTimeString("ja-JP",{timeZone:"Asia/Tokyo"}));K.useEffect(()=>{const u=setInterval(()=>{s(new Date().toLocaleTimeString(t==="フランス"?"fr-FR":"ja-JP",{timeZone:t==="フランス"?"Europe/Paris":"Asia/Tokyo",hour:"2-digit",minute:"2-digit"}))},10);return()=>clearInterval(u)},[t]);const c=u=>{r(u==="France"?"フランス":"日本")};return l.jsxs(Wy,{$bgColor:e,$fontColor:n,children:[l.jsxs(Uy,{$mainBgColor:i,$fontColor:n,children:[l.jsx("button",{onClick:()=>c("France"),style:{backgroundColor:t==="フランス"?a:i},children:"France"}),l.jsx("button",{onClick:()=>c("Japon"),style:{backgroundColor:t==="日本"?a:i},children:"Japon"})]}),l.jsx(Qy,{$mainBgColor:i,children:t}),l.jsx(qy,{$color:a,$mainBgColor:i,children:o})]})}const Yy=j.button`
    display: none;
    @media screen and (max-width: 560px) {
        background-color: ${e=>e.$color};
        color: #F7F7F2;
   ...
   `;function Km({onButtonClick:e}){const{color:n}=P(a=>a.color),{mainBgColor:i}=P(a=>a.mode);return l.jsx(Yy,{$color:n,$bgColor:i,onClick:e,children:"Menu"})}Km.propTypes={onButtonClick:M.func.isRequired};const Gy=j.div`
    display: flex;
    flex-direction: column;
    position: absolute;
    right: 3vw;
...
`;function Xy(){const[e,n]=K.useState(!1),i=()=>{n(!e),console.log("Button clicked!",e)},a=()=>{n(!1)};return l.jsxs(Gy,{$clicked:e?"true":void 0,children:[l.jsx(Lm,{isButtonClicked:e,onLinkClick:a}),l.jsx(Zy,{}),l.jsx(Km,{onButtonClick:i})]})}const e5=j.div`
    display: flex;
    justify-content: center;
    align-items: center;
    width: 100%;
...
`;function $m({onReload:e,onSkip:n,buttonDisabled:i}){const{bgColor:a,mainBgColor:t,fontColor:r}=P(u=>u.mode),{color:o}=P(u=>u.color),s=fi(),c=window.innerWidth<=560?"7vw":"2.5vw";return l.jsxs(a5,{$color:o,$bgColor:a,$mainBgColor:t,$fontColor:r,children:[l.jsx("button",{onClick:()=>{e(),s(-1)},children:"Retour"}),l.jsx("button",{onClick:n,disabled:i,children:"Passer"}),l.jsx("button",{onClick:e,children:l.jsx(Uc,{width:c,height:c,color:o,children:" "})})]})}$m.propTypes={onReload:M.func.isRequired,onSkip:M.func.isRequired,buttonDisabled:M.bool};const t5=j.div`
    display: flex;
    flex-direction: column;
    align-items: center;
    justify-content: center;
...
`;function Om({onReload:e}){const n=fi(),{bgColor:i,fontColor:a,mainBgColor:t}=P(f=>f.mode),{color:r}=P(f=>f.color),o=P(f=>f.parametersExercice.exerciceModeDeJeu),s=P(f=>f.parametersExercice.exerciceNumber),c=P(f=>f.parametersExercice.exerciceDifficulté),u=P(f=>f.parametersExercice.exerciceTimer),d=P(f=>f.exercice.totalTimer),p=P(f=>f.parametersExercice.exerciceTimerActive),h=P(f=>f.exercice.totalfaute),g=P(f=>f.exercice.questionsIncorrectes),[R,y]=K.useState(null),v=(f=>{const w=Math.floor(f/60),k=f%60,C=w.toString().padStart(2,"0"),L=k.toString().padStart(2,"0");return`${C}:${L}`})(d);if(!g)return l.jsx("div",{children:"Loading..."});const m=window.innerWidth<=560?"7vw":"2.5vw";return l.jsxs(t5,{$mainBgColor:t,children:[l.jsxs(r5,{$bgColor:i,children:[l.jsxs(o5,{$mainBgColor:t,$fontColor:a,$color:r,children:[l.jsx("p",{children:"Difficulté"}),l.jsx("p",{children:c})]}),l.jsxs(l5,{$mainBgColor:t,$fontColor:a,$color:r,children:[l.jsx("p",{children:"Nombre de Kanji "}),l.jsx("p",{children:s})]}),l.jsxs(s5,{$mainBgColor:t,$fontColor:a,$color:r,children:[l.jsx("p",{children:"Mode de jeu"}),l.jsx("p",{children:o})]}),l.jsx(c5,{$mainBgColor:t,$fontColor:a,$color:r,children:R&&l.jsxs("div",{children:[l.jsx("h3",{children:R.kanji||R.Dakuten||R.Handakuten||R.hiragana||R.Hiragana||R.Katakana||R.Kanji}),l.jsxs("div",{children:[R.Romaji&&l.jsxs("p",{children:[l.jsx("span",{children:"Romaji "})," ",R.Romaji]}),R.francais&&l.jsxs("p",{children:[l.jsx("span",{children:"Francais "})," ",R.francais]}),R.hiragana&&l.jsxs("p",{children:[l.jsx("span",{children:"Hiragana "})," ",R.hiragana]}),R.OnPrincipalReading&&l.jsxs("p",{children:[l.jsx("span",{children:"On "})," ",R.OnPrincipalReading]}),R.KunPrincipalReading&&l.jsxs("p",{children:[l.jsx("span",{children:"Kun "})," ",R.KunPrincipalReading]}),R.Meaning&&l.jsxs("p",{children:[l.jsx("span",{children:"Francais "})," ",R.Meaning]})]})]})}),l.jsx(d5,{$mainBgColor:t,$fontColor:a,$color:r,children:l.jsx("div",{children:g.length>0?g.filter(Boolean).map((f,w)=>l.jsx("p",{onMouseEnter:()=>y(f),children:f.kanji||(f.Nom==="Handakuten"?f.Handakuten:f.Nom==="Dakuten"?f.Dakuten:f.hiragana||f.Hiragana||f.Katakana||f.Kanji)},w)):l.jsx("p",{children:"pas de faute"})})}),l.jsxs(u5,{$mainBgColor:t,$fontColor:a,$color:r,children:[l.jsx("p",{children:"Erreur"}),l.jsx("p",{children:h})]}),l.jsx(g5,{$mainBgColor:t,$fontColor:a,$color:r,children:l.jsxs("p",{children:[p===!1?v:u,l.jsx("span",{children:"s"})]})}),l.jsx(p5,{$mainBgColor:t,$fontColor:a,$color:r,$bgColor:i,children:l.jsx("div",{})})]}),l.jsxs(f5,{$mainBgColor:t,$fontColor:a,$color:r,$bgColor:i,children:[l.jsxs("button",{onClick:e,children:[" ",l.jsx(Uc,{color:r,width:m,height:m,children:" "})]}),l.jsx("button",{onClick:()=>{e(),n(-1)},children:"Terminer"})]})]})}Om.propTypes={onReload:M.func.isRequired};const m5=j.div`
    display: flex;
    flex-direction: column;
    align-items: center;
    width: 100%;
...
`;function k5(){const{bgColor:e}=P(n=>n.mode);return l.jsxs(y5,{$bgColor:e,children:[l.jsx(w5,{}),l.jsxs(x5,{children:[l.jsx(Iu,{}),l.jsx(Iu,{})]})]})}const P5=j.div`
    display: flex;
    justify-content: center;
    align-items: center;
    gap: 0.5vw;
...
`;function C5(){const{bgColor:e,fontColor:n,mainBgColor:i}=P(s=>s.mode),a=P(s=>s.exercice.totalfaute),t=P(s=>s.exercice.totalreussite),r=P(s=>s.parametersExercice.exerciceNumber),o=t+a;return l.jsxs(P5,{$mainBgColor:i,$bgColor:e,$fontColor:n,children:[l.jsx("p",{children:t}),l.jsxs("p",{children:[o,"/",r]}),l.jsx("p",{children:a})]})}function L5(){return l.jsx("div",{})}const K5=j.div`
    display: flex;
    align-items: center;
...
`;function T5(){return l.jsxs(K5,{children:[l.jsx(C5,{}),location.pathname==="/Exercices/Katakana"||location.pathname==="/Exercices/Hiragana"||location.pathname==="/Exercices/Kanji"&&l.jsx(L5,{})]})}const b5=j.div`
    display: flex;
    align-items: center;
    flex-direction: column;
    justify-content: center;
...
`;function _5(){const e=P(i=>i.mode),{bgColor:n}=P(i=>i.mode);return l.jsxs(D5,{children:[l.jsx(E5,{}),l.jsx(z5,{$bgColor:n,to:"/color",children:l.jsx("img",{src:e.mode==="light"?H5:J5})})]})}const F5=()=>{const{mainBgColor:e}=P(n=>n.mode);return K.useEffect(()=>{document.body.style.backgroundColor=e},[e]),null},A5=j.div`
    display: flex;
    flex-direction: column;
    align-items: center;
    justify-content: center;
...
`,B5=()=>{const{fontColor:e}=P(i=>i.mode),{color:n}=P(i=>i.color);return l.jsxs(A5,{$fontColor:e,$color:n,className:"error404-container",children:[l.jsx("h1",{children:"404"}),l.jsx("p",{children:"Je crois que tu t'es perdu là"}),l.jsx(mi,{to:"/",children:"Retour à l'accueil"})]})};function I5(){const e=ge(),n=!e.pathname.startsWith("/choisir-ses/")&&!e.pathname.startsWith("/Exercices/"),i=!e.pathname.startsWith("/Exercices/");return l.jsxs("div",{className:"App",children:[n&&l.jsx(Xy,{}),i&&l.jsx(F5,{}),i&&l.jsx(_5,{}),l.jsxs(Wv,{children:[l.jsx(an,{path:"/",element:l.jsx(pw,{})}),l.jsx(an,{path:"/kanji",element:l.jsx(bj,{})}),l.jsx(an,{path:"/vocabulaire",element:l.jsx(Oj,{})}),l.jsx(an,{path:"/katakana",element:l.jsx(Mj,{})}),l.jsx(an,{path:"/hiragana",element:l.jsx(Hj,{})}),l.jsx(an,{path:"/nombres",element:l.jsx(Dj,{})}),l.jsx(an,{path:"/dictionnaire/*",element:l.jsx(My,{})}),l.jsx(an,{path:"/choisir-ses/*",element:l.jsx(Iy,{})}),l.jsx(an,{path:"/color",element:l.jsx(AR,{})}),l.jsx(an,{path:"/exercices/*",element:l.jsx($5,{})}),l.jsx(an,{path:"*",element:l.jsx(B5,{})})]})]})}const V5="/Nihongo-V2/",W5=Cl.createRoot(document.getElementById("root"));W5.render(l.jsx(k1,{store:J2,children:l.jsx(Xv,{basename:V5,children:l.jsx(I5,{})})}));
