...
`;function o3(){const{mainBgColor:e}=y(u=>u.mode),{color:n}=y(u=>u.color),i=ce(),a=y(u=>u.search.searchText),t=y(u=>u.search.jlptLevel),r=y(u=>u.search.kanaType),l=y(u=>u.mode),s=y(u=>u.search.vocabulaireCategorie),c=Io.kanji.filter(u=>{var j,x;return(((j=u.Meaning)==null?void 0:j.toLowerCase().includes(a))||((x=u.SecondaryMeaning)==null?void 0:x.toLowerCase().includes(a)))&&(t===""||u.JLPTLevel===t)}).sort((u,j)=>{var h,f,v,R,P,L,C,b,T,z;const x=((h=u.Kanji)==null?void 0:h.toLowerCase().startsWith(a))||((f=u.OnReading)==null?void 0:f.some(G=>G.toLowerCase().startsWith(a)))||((v=u.KunReading)==null?void 0:v.some(G=>G.toLowerCase().startsWith(a)))||((R=u.Meaning)==null?void 0:R.toLowerCase().startsWith(a))||((P=u.SecondaryMeaning)==null?void 0:P.toLowerCase().startsWith(a)),k=((L=j.Kanji)==null?void 0:L.toLowerCase().startsWith(a))||((C=j.OnReading)==null?void 0:C.some(G=>G.toLowerCase().startsWith(a)))||((b=j.KunReading)==null?void 0:b.some(G=>G.toLowerCase().startsWith(a)))||((T=j.Meaning)==null?void 0:T.toLowerCase().startsWith(a))||((z=j.SecondaryMeaning)==null?void 0:z.toLowerCase().startsWith(a));return x&&!k?-1:!x&&k?1:0}),d=[...Oe.Hiragana,...Oe.Dakuten,...Oe.Handakuten,...Oe.Combinaison].filter(u=>{var j,x,k,h;return(((j=u.Hiragana)==null?void 0:j.toLowerCase().includes(a))||((x=u.Dakuten)==null?void 0:x.toLowerCase().includes(a))||((k=u.Handakuten)==null?void 0:k.toLowerCase().includes(a))||((h=u.Romaji)==null?void 0:h.toLowerCase().includes(a)))&&(r===""||u.Type===r)}).sort((u,j)=>{var h,f,v,R,P,L,C,b;const x=((h=u.Hiragana)==null?void 0:h.toLowerCase().startsWith(a))||((f=u.Dakuten)==null?void 0:f.toLowerCase().startsWith(a))||((v=u.Handakuten)==null?void 0:v.toLowerCase().startsWith(a))||((R=u.Romaji)==null?void 0:R.toLowerCase().startsWith(a)),k=((P=j.Hiragana)==null?void 0:P.toLowerCase().startsWith(a))||((L=j.Dakuten)==null?void 0:L.toLowerCase().startsWith(a))||((C=j.Handakuten)==null?void 0:C.toLowerCase().startsWith(a))||((b=j.Romaji)==null?void 0:b.toLowerCase().startsWith(a));return x&&!k?-1:!x&&k?1:0}),g=[...Me.Katakana,...Me.Dakuten,...Me.Handakuten,...Me.Combinaison].filter(u=>{var j,x,k,h;return(((j=u.Katakana)==null?void 0:j.toLowerCase().includes(a))||((x=u.Dakuten)==null?void 0:x.toLowerCase().includes(a))||((k=u.Handakuten)==null?void 0:k.toLowerCase().includes(a))||((h=u.Romaji)==null?void 0:h.toLowerCase().includes(a)))&&(r===""||u.Type===r)}).sort((u,j)=>{var h,f,v,R,P,L,C,b;const x=((h=u.Katakana)==null?void 0:h.toLowerCase().startsWith(a))||((f=u.Dakuten)==null?void 0:f.toLowerCase().startsWith(a))||((v=u.Handakuten)==null?void 0:v.toLowerCase().startsWith(a))||((R=u.Romaji)==null?void 0:R.toLowerCase().startsWith(a)),k=((P=j.Katakana)==null?void 0:P.toLowerCase().startsWith(a))||((L=j.Dakuten)==null?void 0:L.toLowerCase().startsWith(a))||((C=j.Handakuten)==null?void 0:C.toLowerCase().startsWith(a))||((b=j.Romaji)==null?void 0:b.toLowerCase().startsWith(a));return x&&!k?-1:!x&&k?1:0}),p=Array.isArray(Di.vocabulaire)?Di.vocabulaire.filter(u=>{var j,x,k,h;return(((j=u.kanji)==null?void 0:j.toLowerCase().includes(a))||((x=u.hiragana)==null?void 0:x.toLowerCase().includes(a))||((k=u.francais)==null?void 0:k.toLowerCase().includes(a))||((h=u.Romaji)==null?void 0:h.toLowerCase().includes(a)))&&(t===""||u.JLPTLevel===t)&&(s.length===0||s.includes(u.categorie))}).sort((u,j)=>{var h,f,v,R,P,L,C,b;const x=((h=u.kanji)==null?void 0:h.toLowerCase().startsWith(a))||((f=u.hiragana)==null?void 0:f.toLowerCase().startsWith(a))||((v=u.francais)==null?void 0:v.toLowerCase().startsWith(a))||((R=u.Romaji)==null?void 0:R.toLowerCase().startsWith(a)),k=((P=j.kanji)==null?void 0:P.toLowerCase().startsWith(a))||((L=j.hiragana)==null?void 0:L.toLowerCase().startsWith(a))||((C=j.francais)==null?void 0:C.toLowerCase().startsWith(a))||((b=j.Romaji)==null?void 0:b.toLowerCase().startsWith(a));return x&&!k?-1:!x&&k?1:0}):[],m=()=>{document.getElementById("recherche").scrollIntoView({behavior:"smooth"})};return o.jsxs(a3,{children:[o.jsx(Na,{}),o.jsx(gx,{}),o.jsx(qm,{}),i.pathname==="/Dictionnaire/Kanji"&&o.jsx(ld,{kanjiList:c}),i.pathname==="/Dictionnaire/Hiragana"&&o.jsx(sd,{hiraganaList:d}),i.pathname==="/Dictionnaire/Katakana"&&o.jsx(cd,{katakanaList:g}),i.pathname==="/Dictionnaire/Vocabulaire"&&o.jsx(dd,{vocabulaireList:p}),o.jsx(t3,{children:o.jsx(r3,{onClick:m,$mainBgColor:e,$color:n,children:o.jsx("img",{src:l.mode==="light"?Zm:Gm})})})]})}const l3=w.header`
    display: flex;
    flex-direction: column;
    justify-content: center;
    gap: 1vw;
...
`;function ny(){const{bgColor:e,fontColor:n,mainBgColor:i}=y(v=>v.mode),{color:a}=y(v=>v.color);let t="";location.pathname==="/Exercices/Kanji"||location.pathname==="/Nihongo-V2/Exercices/Kanji"?t="Kanji":location.pathname==="/Exercices/Vocabulaire"||location.pathname==="/Nihongo-V2/Exercices/Vocabulaire"?t="vocabulaire":location.pathname==="/Exercices/Hiragana"||location.pathname==="/Nihongo-V2/Exercices/Hiragana"?t="hiragana":location.pathname==="/Exercices/Katakana"||location.pathname==="/Nihongo-V2/Exercices/Katakana"?t="katakana":(location.pathname==="/Exercices/Nombres"||location.pathname==="/Nihongo-V2/Exercices/Nombres")&&(t="nombre");const r=y(v=>v.lvl[`${t}LvL`]),l=y(v=>v.lvl[`${t}Xp`]),s=y(v=>v.lvl[`${t}XpToNextLvL`]),c=window.innerWidth<560?"3vw":"1.5vw",d=window.innerWidth<560?"70%":"100%",g=a,p=e;let m=5,u=parseFloat(6.25),j=parseFloat(7.8);const x=y(v=>v.parametersExercice.exerciceDifficulté);let k="";x==="Débutant"?k=m:x==="Intermédiaire"?k=u:x==="Confirmer"&&(k=j);const h=y(v=>v.exercice.questionsCorrectes);let f="0";return h===!0?f="1":f="0",o.jsx(Z3,{$bgColor:e,$fontColor:n,children:o.jsxs(G3,{$mainBgColor:i,$fontColor:n,children:[o.jsxs("p",{children:["lvl ",r," ",o.jsx("span",{children:t})]}),o.jsx(qo,{xp:l,xpToNextLevel:s,height:c,width:d,color:g,bgColor:p}),o.jsxs(Y3,{children:[l,"/",s," XP"]}),o.jsxs(ey,{$opacity:f,$color:a,children:["+",k,"xp"]})]})})}const iy=w.div`
    display: flex;
    align-items: center;
    justify-content: space-between;
    width: 100%;
