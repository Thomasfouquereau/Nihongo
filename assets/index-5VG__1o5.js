...
`;function jm(){const e=ge(),n=Ie(),{bgColor:i,fontColor:a,mainBgColor:t}=x(u=>u.mode),{color:r}=x(u=>u.color),s=(()=>{switch(e.pathname){case"/Katakana":return{normal:"キ",accents:"ギ",combinaison:"ギャ",tout:"キギギャ"};case"/Hiragana":return{normal:"き",accents:"ぎ",combinaison:"きゃ",tout:"きぎきゃ"};default:return null}})();if(!s)return l.jsx("div",{children:"Chemin non pris en charge"});const c=u=>{n(Fp(u))};return l.jsxs($y,{$bgColor:i,$mainBgColor:t,$fontColor:a,$color:r,children:[l.jsx("button",{onClick:()=>c("normal"),children:l.jsxs("div",{children:[l.jsx("p",{children:s.normal}),l.jsx("p",{children:"normal"})]})}),l.jsx("button",{onClick:()=>c("accents"),children:l.jsxs("div",{children:[l.jsx("p",{children:s.accents}),l.jsx("p",{children:"accents"})]})}),l.jsx("button",{onClick:()=>c("combinaison"),children:l.jsxs("div",{children:[l.jsx("p",{children:s.combinaison}),l.jsx("p",{children:"combinaison"})]})}),l.jsx("button",{onClick:()=>c("tout"),children:l.jsxs("div",{children:[l.jsx("p",{children:s.tout}),l.jsx("p",{children:"tout"})]})})]})}const Oy=y.header`
    display: flex;
    flex-direction: column;
    gap: 1vw;
    margin-left: 3vw;
...
`;function My(){return l.jsxs(Sy,{children:[l.jsx(Ka,{}),l.jsx(Jt,{}),l.jsx(Dt,{}),l.jsx(jm,{}),l.jsx(zt,{}),l.jsx(_t,{}),l.jsx(Ft,{})]})}const Ey=y.header`
    display: flex;
    flex-direction: column;
    gap: 1vw;
    margin-left: 3vw;
...
`;function Za({onSearchChange:e}){const{fontColor:n,mainBgColor:i}=x(g=>g.mode),{color:a}=x(g=>g.color),t=x(g=>g.search.searchText),r=ge(),[o,s]=K.useState(""),u=(()=>{switch(r.pathname){case"/Dictionnaire/Kanji":case"/choisir-ses/Kanji":return{titleFr:"Kanji"};case"/Dictionnaire/Hiragana":case"/choisir-ses/Hiragana":return{titleFr:"Hiragana"};case"/Dictionnaire/Katakana":case"/choisir-ses/Katakana":return{titleFr:"Katakana"};case"/Dictionnaire/Vocabulaire":case"/choisir-ses/Vocabulaire":return{titleFr:"Vocabulaire"};case"/Dictionnaire/Nombres":case"/choisir-ses/Nombres":return{titleFr:"Nombres"};default:return"Accueil"}})(),d=g=>{s(g.target.value),e(g.target.value)},f=()=>{s(""),e("")};return l.jsxs(_y,{children:[l.jsx(zy,{type:"text",placeholder:`Rechercher un ${u.titleFr}`,value:t||o,onChange:d,$color:a,$mainBgColor:i,$fontColor:n}),t?l.jsx("button",{onClick:f,children:l.jsx(ue,{color:a})}):l.jsx("button",{children:l.jsx(ym,{color:a})})]})}Za.propTypes={onSearchChange:E.func.isRequired};const Fy=y.div`
display: flex;
gap: 0.6vw;
height: 100%;
...
`;function Es({filterJlpt:e}){const[n,i]=K.useState("N5"),a=s=>{const c=s.target.value;n===c?(i(""),e("")):(i(c),e(c))},{fontColor:t,mainBgColor:r}=x(s=>s.mode),{color:o}=x(s=>s.color);return l.jsxs(Fy,{name:"jlpt",id:"jlpt",value:n,$mainBgColor:r,$fontColor:t,$color:o,children:[l.jsx("button",{value:"N5",onClick:a,children:"N5"}),l.jsx("button",{value:"N4",onClick:a,children:"N4"}),l.jsx("button",{value:"N3",onClick:a,children:"N3"}),l.jsx("button",{value:"N2",onClick:a,children:"N2"}),l.jsx("button",{value:"N1",onClick:a,children:"N1"})]})}Es.propTypes={filterJlpt:E.func.isRequired};const Ay=y.div`
display: flex;
gap: 0.6vw;
height: 100%;
min-width: calc(40% - 0.7vw);
...
`,Yy=y.div`
    ...
    gap: 1vw;
    flex-direction: column;
`;function Pm(){const{bgColor:e}=x(s=>s.mode),n=Ie(),i=ge(),a=s=>{n(Hc(s.toLowerCase()))},t=s=>{n(R2(s))},r=s=>{n(Jc(s))},o=s=>{n(j2(s))};return l.jsxs("div",{id:"recherche",children:[(i.pathname==="/Dictionnaire/Kanji"||i.pathname==="/choisir-ses/Kanji")&&l.jsxs(dr,{$bgColor:e,children:[l.jsx(Za,{onSearchChange:a}),l.jsx(Es,{filterJlpt:t})]}),(i.pathname==="/Dictionnaire/Vocabulaire"||i.pathname==="/choisir-ses/Vocabulaire")&&l.jsxs(Yy,{children:[l.jsxs(dr,{$bgColor:e,children:[l.jsx(Za,{onSearchChange:a}),l.jsx(Es,{filterJlpt:t})]}),l.jsx("div",{children:l.jsx(km,{filterVocabulaire:o})})]}),(i.pathname==="/Dictionnaire/Katakana"||i.pathname==="/Dictionnaire/Hiragana"||i.pathname==="/choisir-ses/Katakana"||i.pathname==="/choisir-ses/Hiragana")&&l.jsxs(dr,{$bgColor:e,children:[l.jsx(Za,{onSearchChange:a}),l.jsx(wm,{filterKana:r})]}),(i.pathname==="/Dictionnaire/Nombres"||i.pathname==="/choisir-ses/Nombres")&&l.jsx(dr,{$bgColor:e,children:l.jsx(Za,{onSearchChange:a})})]})}const Gy=y.div`
    display: flex;
    flex-wrap: wrap;
    gap: 0.6vw;
    width: calc(100% - 3vw);
...
`;function Bc({kanjiList:e}){const{bgColor:n,fontColor:i,mainBgColor:a}=x(d=>d.mode),{color:t}=x(d=>d.color),r=x(d=>d.dataChoice.kanji),o=x(d=>d.parametersExercice.exerciceNumber),s=Ie(),c=ge(),u=d=>{(r.includes(d)||r.length<o)&&c.pathname==="/choisir-ses/Kanji"&&s(L2(d))};return l.jsx(Gy,{children:Array.isArray(e)&&e.length>0?e.map(d=>l.jsxs(Xy,{$bgColor:n,onClick:()=>u(d),style:{backgroundColor:r.includes(d)?"#858585":n,cursor:"pointer"},children:[l.jsxs(ew,{$fontColor:i,$mainBgColor:a,children:[l.jsx("span",{children:"Kun"})," ",d.KunReading.join(", ")]}),l.jsxs(nw,{$fontColor:i,$mainBgColor:a,$color:t,children:[d.SecondaryMeaning&&l.jsx("p",{children:d.SecondaryMeaning}),l.jsx("h2",{children:d.Kanji}),l.jsx("p",{children:d.Meaning})]}),l.jsxs(iw,{$fontColor:i,$mainBgColor:a,$color:t,children:[l.jsxs("p",{children:[l.jsx("span",{children:"JLPT"})," ",d.JLPTLevel]}),l.jsxs("p",{children:[l.jsx("span",{children:"On"})," ",d.OnReading.join(", ")]})]})]},d.id)):l.jsx(aw,{$bgColor:n,$color:t,$mainBgColor:a,children:l.jsx("p",{children:"Aucun résultat"})})})}Bc.propTypes={kanjiList:E.array.isRequired};const Kn="/Nihongo-V2/assets/icon-audio-Dmg04iGg.svg",tw=y.div`
    display: flex;
    flex-wrap: wrap;
    gap: 0.6vw;
    width: calc(100% - 3vw);
...
`;function Wc({vocabulaireList:e=[]}){const{bgColor:n,fontColor:i,mainBgColor:a}=x(d=>d.mode),{color:t}=x(d=>d.color),r=x(d=>d.dataChoice.vocabulaire),o=x(d=>d.parametersExercice.exerciceNumber),s=Ie(),c=ge(),u=d=>{(r.includes(d)||r.length<o)&&c.pathname==="/choisir-ses/Vocabulaire"&&s(K2(d))};return l.jsx(Pw,{children:Array.isArray(e)&&e.length>0?e.map(d=>l.jsxs(xw,{$bgColor:n,onClick:()=>u(d),style:{backgroundColor:r.includes(d)?"#858585":n,cursor:"pointer"},children:[l.jsxs(Cw,{$color:t,$fontColor:i,$mainBgColor:a,children:[l.jsxs("p",{children:[d.kanji," ",l.jsx("span",{children:"Kanji"})]}),l.jsxs("p",{children:[d.hiragana," ",l.jsx("span",{children:"Hiragana"})]})]}),l.jsxs(Lw,{$color:t,$fontColor:i,$mainBgColor:a,children:[l.jsxs("p",{children:[d.francais," ",l.jsx("span",{children:"Français"})]}),l.jsxs("p",{children:[d.Romaji," ",l.jsx("span",{children:"Romaji"})]})]}),l.jsxs(Kw,{$color:t,$fontColor:i,$mainBgColor:a,children:[l.jsxs("div",{children:[l.jsx("span",{children:Array.isArray(d.categorie)&&d.categorie[0]}),Array.isArray(d.categorie)&&d.categorie[1]&&l.jsx("span",{children:d.categorie[1]}),Array.isArray(d.categorie)&&d.categorie[2]&&l.jsx("span",{children:d.categorie[2]})]}),l.jsxs("p",{children:[l.jsx("span",{children:"JLPT"}),d.niveau]})]})]},d.id)):l.jsx(kw,{$fontColor:i,$bgColor:n,$color:t,$mainBgColor:a,children:l.jsx("p",{children:"Aucun résultat"})})})}Wc.propTypes={vocabulaireList:E.array.isRequired};const xm="data:image/svg+xml,%3csvg%20width='50'%20height='37'%20viewBox='0%200%2050%2037'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M22.4002%202.32351C23.5849%201.06396%2025.5862%201.06396%2026.7708%202.32351L41.1226%2017.5828C42.9235%2019.4976%2041.5659%2022.6382%2038.9373%2022.6382H10.2338C7.60519%2022.6382%206.24759%2019.4976%208.04849%2017.5828L22.4002%202.32351Z'%20fill='%23F7F7F2'/%3e%3crect%20x='19.6904'%20y='14.9575'%20width='9.41714'%20height='22.0426'%20rx='3'%20fill='%23F7F7F2'/%3e%3c/svg%3e",Cm="data:image/svg+xml,%3csvg%20width='50'%20height='37'%20viewBox='0%200%2050%2037'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M22.4002%202.32351C23.5849%201.06396%2025.5862%201.06396%2026.7708%202.32351L41.1226%2017.5828C42.9235%2019.4976%2041.5659%2022.6382%2038.9373%2022.6382H10.2338C7.60519%2022.6382%206.24759%2019.4976%208.04849%2017.5828L22.4002%202.32351Z'%20fill='%23353535'/%3e%3crect%20x='19.6904'%20y='14.957'%20width='9.41714'%20height='22.0426'%20rx='3'%20fill='%23353535'/%3e%3c/svg%3e",Tw=y.header`
    display: flex;
    flex-direction: column;
    justify-content: center;
    gap: 1vw;
...
`;function Ow(){const{mainBgColor:e}=x(v=>v.mode),{color:n}=x(v=>v.color),i=ge(),a=x(v=>v.search.searchText),t=x(v=>v.search.jlptLevel),r=x(v=>v.search.kanaType),o=x(v=>v.mode),s=x(v=>v.search.vocabulaireCategorie),c=So.kanji.filter(v=>{var R,w;return(((R=v.Meaning)==null?void 0:R.toLowerCase().includes(a))||((w=v.SecondaryMeaning)==null?void 0:w.toLowerCase().includes(a)))&&(t===""||v.JLPTLevel===t)}).sort((v,R)=>{var h,p,m,j,P,L,C,b,_,D;const w=((h=v.Kanji)==null?void 0:h.toLowerCase().startsWith(a))||((p=v.OnReading)==null?void 0:p.some(Q=>Q.toLowerCase().startsWith(a)))||((m=v.KunReading)==null?void 0:m.some(Q=>Q.toLowerCase().startsWith(a)))||((j=v.Meaning)==null?void 0:j.toLowerCase().startsWith(a))||((P=v.SecondaryMeaning)==null?void 0:P.toLowerCase().startsWith(a)),k=((L=R.Kanji)==null?void 0:L.toLowerCase().startsWith(a))||((C=R.OnReading)==null?void 0:C.some(Q=>Q.toLowerCase().startsWith(a)))||((b=R.KunReading)==null?void 0:b.some(Q=>Q.toLowerCase().startsWith(a)))||((_=R.Meaning)==null?void 0:_.toLowerCase().startsWith(a))||((D=R.SecondaryMeaning)==null?void 0:D.toLowerCase().startsWith(a));return w&&!k?-1:!w&&k?1:0}),u=[...be.Hiragana,...be.Dakuten,...be.Handakuten,...be.Combinaison].filter(v=>{var R,w,k,h;return(((R=v.Hiragana)==null?void 0:R.toLowerCase().includes(a))||((w=v.Dakuten)==null?void 0:w.toLowerCase().includes(a))||((k=v.Handakuten)==null?void 0:k.toLowerCase().includes(a))||((h=v.Romaji)==null?void 0:h.toLowerCase().includes(a)))&&(r===""||v.Type===r)}).sort((v,R)=>{var h,p,m,j,P,L,C,b;const w=((h=v.Hiragana)==null?void 0:h.toLowerCase().startsWith(a))||((p=v.Dakuten)==null?void 0:p.toLowerCase().startsWith(a))||((m=v.Handakuten)==null?void 0:m.toLowerCase().startsWith(a))||((j=v.Romaji)==null?void 0:j.toLowerCase().startsWith(a)),k=((P=R.Hiragana)==null?void 0:P.toLowerCase().startsWith(a))||((L=R.Dakuten)==null?void 0:L.toLowerCase().startsWith(a))||((C=R.Handakuten)==null?void 0:C.toLowerCase().startsWith(a))||((b=R.Romaji)==null?void 0:b.toLowerCase().startsWith(a));return w&&!k?-1:!w&&k?1:0}),d=[...$e.Katakana,...$e.Dakuten,...$e.Handakuten,...$e.Combinaison].filter(v=>{var R,w,k,h;return(((R=v.Katakana)==null?void 0:R.toLowerCase().includes(a))||((w=v.Dakuten)==null?void 0:w.toLowerCase().includes(a))||((k=v.Handakuten)==null?void 0:k.toLowerCase().includes(a))||((h=v.Romaji)==null?void 0:h.toLowerCase().includes(a)))&&(r===""||v.Type===r)}).sort((v,R)=>{var h,p,m,j,P,L,C,b;const w=((h=v.Katakana)==null?void 0:h.toLowerCase().startsWith(a))||((p=v.Dakuten)==null?void 0:p.toLowerCase().startsWith(a))||((m=v.Handakuten)==null?void 0:m.toLowerCase().startsWith(a))||((j=v.Romaji)==null?void 0:j.toLowerCase().startsWith(a)),k=((P=R.Katakana)==null?void 0:P.toLowerCase().startsWith(a))||((L=R.Dakuten)==null?void 0:L.toLowerCase().startsWith(a))||((C=R.Handakuten)==null?void 0:C.toLowerCase().startsWith(a))||((b=R.Romaji)==null?void 0:b.toLowerCase().startsWith(a));return w&&!k?-1:!w&&k?1:0}),f=Array.isArray(Mi.vocabulaire)?Mi.vocabulaire.filter(v=>{var R,w,k,h;return(((R=v.kanji)==null?void 0:R.toLowerCase().includes(a))||((w=v.hiragana)==null?void 0:w.toLowerCase().includes(a))||((k=v.francais)==null?void 0:k.toLowerCase().includes(a))||((h=v.Romaji)==null?void 0:h.toLowerCase().includes(a)))&&(t===""||v.niveau===t)&&(s.length===0||s.includes(v.categorie))}).sort((v,R)=>{var h,p,m,j,P,L,C,b;const w=((h=v.kanji)==null?void 0:h.toLowerCase().startsWith(a))||((p=v.hiragana)==null?void 0:p.toLowerCase().startsWith(a))||((m=v.francais)==null?void 0:m.toLowerCase().startsWith(a))||((j=v.Romaji)==null?void 0:j.toLowerCase().startsWith(a)),k=((P=R.kanji)==null?void 0:P.toLowerCase().startsWith(a))||((L=R.hiragana)==null?void 0:L.toLowerCase().startsWith(a))||((C=R.francais)==null?void 0:C.toLowerCase().startsWith(a))||((b=R.Romaji)==null?void 0:b.toLowerCase().startsWith(a));return w&&!k?-1:!w&&k?1:0}):[],g=()=>{document.getElementById("recherche").scrollIntoView({behavior:"smooth"})};return l.jsxs(Tw,{children:[l.jsx(Ka,{}),l.jsx(Dy,{}),l.jsx(Pm,{}),i.pathname==="/Dictionnaire/Kanji"&&l.jsx(Bc,{kanjiList:c}),i.pathname==="/Dictionnaire/Hiragana"&&l.jsx(Ic,{hiraganaList:u}),i.pathname==="/Dictionnaire/Katakana"&&l.jsx(Vc,{katakanaList:d}),i.pathname==="/Dictionnaire/Vocabulaire"&&l.jsx(Wc,{vocabulaireList:f}),l.jsx(bw,{children:l.jsx($w,{onClick:g,$mainBgColor:e,$color:n,children:l.jsx("img",{src:o.mode==="light"?xm:Cm})})})]})}const Nw="data:image/svg+xml,%3csvg%20width='68'%20height='69'%20viewBox='0%200%2068%2069'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3crect%20x='19.5039'%20y='15.0547'%20width='48'%20height='7'%20rx='3'%20transform='rotate(45%2019.5039%2015.0547)'%20fill='%23353535'/%3e%3crect%20x='14.5542'%20y='48.9951'%20width='48'%20height='7'%20rx='3'%20transform='rotate(-45%2014.5542%2048.9951)'%20fill='%23353535'/%3e%3c/svg%3e",Sw=y.header`
    display: flex;
    flex-direction: column;
    justify-content: center;
    gap: 1vw;
...
`,Ww=y.span`
    ...
    margin: 0;
    border-radius: 0.5vw;
`;function Uw(){const{bgColor:e,fontColor:n,mainBgColor:i}=x(u=>u.mode),{color:a}=x(u=>u.color),[t,r]=K.useState("日本"),[o,s]=K.useState(new Date().toLocaleTimeString("ja-JP",{timeZone:"Asia/Tokyo"}));K.useEffect(()=>{const u=setInterval(()=>{s(new Date().toLocaleTimeString(t==="フランス"?"fr-FR":"ja-JP",{timeZone:t==="フランス"?"Europe/Paris":"Asia/Tokyo",hour:"2-digit",minute:"2-digit"}))},10);return()=>clearInterval(u)},[t]);const c=u=>{r(u==="France"?"フランス":"日本")};return l.jsxs(Bw,{$bgColor:e,$fontColor:n,children:[l.jsxs(Iw,{$mainBgColor:i,$fontColor:n,children:[l.jsx("button",{onClick:()=>c("France"),style:{backgroundColor:t==="フランス"?a:i},children:"France"}),l.jsx("button",{onClick:()=>c("Japon"),style:{backgroundColor:t==="日本"?a:i},children:"Japon"})]}),l.jsx(Vw,{$mainBgColor:i,children:t}),l.jsx(Ww,{$color:a,$mainBgColor:i,children:o})]})}const Qw=y.div`  
    display: flex;
    flex-direction: column;
    position: absolute;
    right: 3vw;
    top: 6vw;
    gap: 1vw;
`;function qw(){return l.jsxs(Qw,{children:[l.jsx(Aw,{}),l.jsx(Uw,{})]})}const Zw=y.div`
    display: flex;
    justify-content: center;
    align-items: center;
    width: 100%;
...
`;function bm({onReload:e}){const n=pi(),{bgColor:i,fontColor:a,mainBgColor:t}=x(p=>p.mode),{color:r}=x(p=>p.color),o=x(p=>p.parametersExercice.exerciceModeDeJeu),s=x(p=>p.parametersExercice.exerciceNumber),c=x(p=>p.parametersExercice.exerciceDifficulté),u=x(p=>p.parametersExercice.exerciceTimer),d=x(p=>p.exercice.totalTimer),f=x(p=>p.parametersExercice.exerciceTimerActive),g=x(p=>p.exercice.totalfaute),v=x(p=>p.exercice.questionsIncorrectes),[R,w]=K.useState(null),h=(p=>{const m=Math.floor(p/60),j=p%60,P=m.toString().padStart(2,"0"),L=j.toString().padStart(2,"0");return`${P}:${L}`})(d);return v?l.jsxs(ek,{$mainBgColor:t,children:[l.jsxs(nk,{$bgColor:i,children:[l.jsxs(ik,{$mainBgColor:t,$fontColor:a,$color:r,children:[l.jsx("p",{children:"Difficulté"}),l.jsx("p",{children:c})]}),l.jsxs(ak,{$mainBgColor:t,$fontColor:a,$color:r,children:[l.jsx("p",{children:"Nombre de Kanji "}),l.jsx("p",{children:s})]}),l.jsxs(tk,{$mainBgColor:t,$fontColor:a,$color:r,children:[l.jsx("p",{children:"Mode de jeu"}),l.jsx("p",{children:o})]}),l.jsx(rk,{$mainBgColor:t,$fontColor:a,$color:r,children:R&&l.jsxs("div",{children:[l.jsx("h3",{children:R.kanji||R.Dakuten||R.Handakuten||R.hiragana||R.Hiragana||R.Katakana||R.Kanji}),l.jsxs("div",{children:[R.Romaji&&l.jsxs("p",{children:[l.jsx("span",{children:"Romaji "})," ",R.Romaji]}),R.francais&&l.jsxs("p",{children:[l.jsx("span",{children:"Francais "})," ",R.francais]}),R.hiragana&&l.jsxs("p",{children:[l.jsx("span",{children:"Hiragana "})," ",R.hiragana]}),R.OnPrincipalReading&&l.jsxs("p",{children:[l.jsx("span",{children:"On "})," ",R.OnPrincipalReading]}),R.KunPrincipalReading&&l.jsxs("p",{children:[l.jsx("span",{children:"Kun "})," ",R.KunPrincipalReading]}),R.Meaning&&l.jsxs("p",{children:[l.jsx("span",{children:"Francais "})," ",R.Meaning]})]})]})}),l.jsx(ok,{$mainBgColor:t,$fontColor:a,$color:r,children:l.jsx("div",{children:v.length>0?v.filter(Boolean).map((p,m)=>l.jsx("p",{onMouseEnter:()=>w(p),children:p.kanji||(p.Nom==="Handakuten"?p.Handakuten:p.Nom==="Dakuten"?p.Dakuten:p.hiragana||p.Hiragana||p.Katakana||p.Kanji)},m)):l.jsx("p",{children:"pas de faute"})})}),l.jsxs(lk,{$mainBgColor:t,$fontColor:a,$color:r,children:[l.jsx("p",{children:"Erreur"}),l.jsx("p",{children:g})]}),l.jsx(sk,{$mainBgColor:t,$fontColor:a,$color:r,children:l.jsxs("p",{children:[f===!1?h:u,l.jsx("span",{children:"s"})]})}),l.jsx(ck,{$mainBgColor:t,$fontColor:a,$color:r,$bgColor:i,children:l.jsx("div",{})})]}),l.jsxs(uk,{$mainBgColor:t,$fontColor:a,$color:r,$bgColor:i,children:[l.jsxs("button",{onClick:e,children:[" ",l.jsx(Uc,{color:r,children:" "})]}),l.jsx("button",{onClick:()=>{e(),n(-1)},children:"Terminer"})]})]}):l.jsx("div",{children:"Loading..."})}bm.propTypes={onReload:E.func.isRequired};const dk=y.div`
    display: flex;
    flex-direction: column;
    align-items: center;
    width: 100%;
...
`,Bd=(e,n)=>{const i=[e],a=n.filter(t=>t!==e);for(;i.length<4;){const t=Math.floor(Math.random()*a.length),r=a[t];i.includes(r)||i.push(r)}return i.sort(()=>.5-Math.random())};function mk(){const e=x(N=>N.parametersExercice.exerciceModeDeJeu),n=x(N=>N.parametersExercice.exerciceNumber),i=x(N=>N.dataChoice),a=x(N=>N.parametersExercice.exerciceTypeDeKana),t=x(N=>N.parametersExercice.exerciceTimerActive),r=x(N=>N.dataChoice.katakana),o=x(N=>N.dataChoice.hiragana),{bgColor:s}=x(N=>N.mode),[c,u]=K.useState([]),[d,f]=K.useState(0),[g,v]=K.useState(null),[R,w]=K.useState(0),k=K.useRef(null),h=K.useRef(null),p=Ie(),m=ge(),j=x(N=>N.parametersExercice.exerciceTimer),[P,L]=K.useState(j),{color:C}=x(N=>N.color),[b,_]=K.useState(1),[D,Q]=K.useState(1),[T,J]=K.useState(!1),[W,Y]=K.useState(!1),q=K.useCallback(N=>{Q(A=>A+1),p(lr(D)),N===!0&&(Q(1),p(lr(D)))},[Q,p,D]),ne=K.useCallback((N,A)=>{_($n=>$n+1),p(or(b)),p(x2(A)),N===!0&&(_(1),p(or(b)))},[_,p,b]),O=K.useCallback(()=>{h.current&&clearInterval(h.current),w(0),t===!1&&(h.current=setInterval(()=>{w(N=>N+1)},1e3))},[t]),S=K.useCallback(()=>{h.current&&(clearInterval(h.current),h.current=null)},[]),H=K.useCallback(()=>{L(j),k.current&&k.current()},[j]),F=K.useCallback(()=>{if(t===!0){const N=c[d];setTimeout(()=>{d<c.length-1?(f(d+1),ne(!1,N)):(ne(!1,N),Y(!0),p(xd(R)),S())},900)}},[d,c,t,ne,S,p,R]);K.useEffect(()=>{if(t===!0&&W===!1){const N=setInterval(()=>{L(A=>A<=1?(clearInterval(N),F(),setTimeout(()=>{L(j)},900),0):A-1)},1e3);return()=>clearInterval(N)}},[j,F,p,t,W]),K.useEffect(()=>{L(j)},[j]),K.useEffect(()=>{H&&H(j)},[H,j]);const z=K.useCallback(()=>{let N;if(m.pathname.includes("/Exercices/Kanji")?(O(),N=So.kanji):m.pathname.includes("/Exercices/Hiragana")?(O(),a==="normal"?N=be.Hiragana:a==="accents"?N=[...be.Dakuten,...be.Handakuten]:a==="combinaison"?N=be.Combinaison:a==="tout"&&(N=[...be.Hiragana,...be.Dakuten,...be.Handakuten,...be.Combinaison],e==="Choisir ses questions"&&(N=o.map(A=>A.affiche==="Hiragana"?{...A,Type:"Hiragana"}:A.affiche==="Accents"?{...A,Type:A.affiche==="Accents"?"Dakuten":"Handakuten"}:{...A,Type:"Combinaison"})))):m.pathname.includes("/Exercices/Vocabulaire")?(O(),N=Mi.vocabulaire):m.pathname.includes("/Exercices/Nombres")?(O(),N=Mi.nombres):m.pathname.includes("/Exercices/Katakana")&&(O(),a==="normal"?N=$e.Katakana:a==="accents"?N=[...$e.Dakuten,...$e.Handakuten]:a==="combinaison"?N=$e.Combinaison:a==="tout"?(N=[...$e.Katakana,...$e.Dakuten,...$e.Handakuten,...$e.Combinaison],e==="Choisir ses questions"&&(N=r.map(A=>A.affiche==="Katakana"?{...A,Type:"Katakana"}:A.affiche==="Accents"?{...A,Type:A.affiche==="Accents"?"Dakuten":"Handakuten"}:{...A,Type:"Combinaison"}))):S()),N){let A=[];if(e==="Aléatoire")A=N.sort(()=>.5-Math.random()).slice(0,n);else if(e==="N5")A=N.filter(G=>G.JLPTLevel==="N5").sort(()=>.5-Math.random()).slice(0,n);else if(e==="Choisir ses questions"){if(p(Fp("tout")),m.pathname.includes("/Exercices/Kanji")&&i.kanji){const G=i.kanji.map(X=>X.Kanji);A=N.filter(X=>G.includes(X.Kanji)).sort(()=>.5-Math.random()).slice(0,n),console.log(A)}else if(m.pathname.includes("/Exercices/Vocabulaire")&&i.vocabulaire){const G=i.vocabulaire.map(X=>X.francais);A=N.filter(X=>G.includes(X.francais)).sort(()=>.5-Math.random()).slice(0,n)}else if(m.pathname.includes("/Exercices/Hiragana")&&i.hiragana){const G=i.hiragana.map(X=>X.hiragana);A=N.filter(X=>G.includes(X.hiragana)).sort(()=>.5-Math.random()).slice(0,n)}else if(m.pathname.includes("/Exercices/Katakana")&&i.katakana){const G=i.katakana.map(X=>X.Katakana);A=N.filter(X=>G.includes(X.Katakana)).sort(()=>.5-Math.random()).slice(0,n)}else if(m.pathname.includes("/Exercices/Nombres")&&i.nombre){const G=i.nombre.map(X=>X.francais);A=N.filter(X=>G.includes(X.francais)).sort(()=>.5-Math.random()).slice(0,n)}}const $n=A.map(G=>{if(m.pathname.includes("/Exercices/Hiragana")||m.pathname.includes("/Exercices/Katakana")){const X=G.Romaji,Bn=Bd(X,N.map(Ve=>Ve.Romaji));return{...G,options:Bn,id:G.id.toString()}}else{const X=G.Meaning||G.francais,Bn=Bd(X,N.map(Ve=>Ve.Meaning||Ve.francais));return{...G,options:Bn,id:G.id.toString()}}});u($n),f(0)}},[e,n,i,a,m.pathname,O,S,p,r,o]);K.useEffect(()=>{const N=()=>{p(or(0)),p(lr(0))};z(),S(),O(),N()},[z,S,O,p]);const ce=N=>{v(N);const A=c[d];N?(q(),J(!0),S()):(ne(!1,A),J(!0),S()),setTimeout(()=>{d<c.length-1?(f(d+1),v(null)):(p(xd(R)),Y(!0)),v(null),J(!1),L(j)},900),k.current&&k.current()},Le=()=>{ce(!1)},Je=()=>{q(!0),ne(!0),p(lr(0)),p(or(0)),z(),S(),O(),Y(!1),p(C2()),L(j)};return l.jsxs(dk,{children:[W===!0?l.jsx(bm,{onReload:Je}):null,l.jsxs(gk,{$bgColor:s,children:[t===!0&&l.jsx(pk,{$color:C,children:l.jsxs("p",{children:[P,l.jsx("span",{children:"s"})]})}),c&&c.length>0?l.jsxs(fk,{children:[l.jsx(Lm,{question:c[d],isCorrect:g}),l.jsx(Km,{question:c[d],options:c[d].options,onAnswer:ce,isCorrect:g,buttonDisabled:T})]},c[d].id):l.jsx("p",{children:"Aucune question disponible."})]}),l.jsx(Tm,{onReload:Je,onSkip:Le,buttonDisabled:T})]})}const hk=y.div`
    ...
    width: 78%;
    min-height: 80%;
`;function vk(){const{bgColor:e}=x(n=>n.mode);return l.jsx(hk,{$bgColor:e,children:l.jsx(mk,{})})}const Rk=y.div`
    display: flex;
    justify-content: center;
    align-items: center;
    gap: 0.5vw;
...
`;function jk(){const{bgColor:e,fontColor:n,mainBgColor:i}=x(s=>s.mode),a=x(s=>s.exercice.totalfaute),t=x(s=>s.exercice.totalreussite),r=x(s=>s.parametersExercice.exerciceNumber),o=t+a;return l.jsxs(Rk,{$mainBgColor:i,$bgColor:e,$fontColor:n,children:[l.jsx("p",{children:t}),l.jsxs("p",{children:[o,"/",r]}),l.jsx("p",{children:a})]})}function yk(){return l.jsx("div",{})}const wk=y.div`
    display: flex;
    align-items: center;
    justify-content: flex-start;
    width: 100%;
    height: 20%;
`;function kk(){return l.jsxs(wk,{children:[l.jsx(jk,{}),location.pathname==="/Exercices/Katakana"||location.pathname==="/Exercices/Hiragana"||location.pathname==="/Exercices/Kanji"&&l.jsx(yk,{})]})}const Pk=y.div`
    width: 6vw;
    border-radius: 0.8vw;
    padding: 1vw;
    height: 32vw;
...
`;function Id(){const e=x(s=>s.parametersExercice.exerciceNumber),n=x(s=>s.exercice.totalfaute),i=x(s=>s.exercice.totalreussite),{color:a}=x(s=>s.color),{bgColor:t,mainBgColor:r}=x(s=>s.mode),o=(n+i)/e*100;return l.jsx(Pk,{$bgColor:t,$mainBgColor:r,$color:a,children:l.jsx("div",{children:l.jsx("div",{style:{height:`${o}%`}})})})}const xk=y.div`
    display: flex;
    align-items: center;
    flex-direction: column;
    justify-content: center;
...
`;function Hk(){const e=x(i=>i.mode),{bgColor:n}=x(i=>i.mode);return l.jsxs(Mk,{children:[l.jsx(Ok,{}),l.jsx(Ek,{$bgColor:n,to:"/color",children:l.jsx("img",{src:e.mode==="light"?Nk:Sk})})]})}const Jk=()=>{const{mainBgColor:e}=x(n=>n.mode);return K.useEffect(()=>{document.body.style.backgroundColor=e},[e]),null};function Dk(){const e=ge(),n=!e.pathname.startsWith("/choisir-ses/")&&!e.pathname.startsWith("/Exercices/"),i=!e.pathname.startsWith("/Exercices/");return l.jsxs("div",{className:"App",children:[n&&l.jsx(qw,{}),i&&l.jsx(Jk,{}),i&&l.jsx(Hk,{}),l.jsxs(Iv,{children:[l.jsx(dn,{path:"/",element:l.jsx(dj,{})}),l.jsx(dn,{path:"/kanji",element:l.jsx(Ky,{})}),l.jsx(dn,{path:"/vocabulaire",element:l.jsx(by,{})}),l.jsx(dn,{path:"/katakana",element:l.jsx(Ny,{})}),l.jsx(dn,{path:"/hiragana",element:l.jsx(My,{})}),l.jsx(dn,{path:"/nombres",element:l.jsx(Hy,{})}),l.jsx(dn,{path:"/dictionnaire/*",element:l.jsx(Ow,{})}),l.jsx(dn,{path:"/choisir-ses/*",element:l.jsx(zw,{})}),l.jsx(dn,{path:"/color",element:l.jsx(zR,{})}),l.jsx(dn,{path:"/exercices/*",element:l.jsx(Lk,{})})]})]})}const _k="/Nihongo-V2/",zk=Cl.createRoot(document.getElementById("root"));zk.render(l.jsx(w1,{store:E2,children:l.jsx(Yv,{basename:_k,children:l.jsx(Dk,{})})}));
