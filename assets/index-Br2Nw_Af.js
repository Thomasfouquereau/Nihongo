 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Ht=K;function u2(e,n){return e===n&&(e!==0||1/e===1/n)||e!==e&&n!==n}var g2=typeof Object.is=="function"?Object.is:u2,p2=Ht.useSyncExternalStore,f2=Ht.useRef,m2=Ht.useEffect,h2=Ht.useMemo,v2=Ht.useDebugValue;Uf.useSyncExternalStoreWithSelector=function(e,n,i,a,t){var r=f2(null);if(r.current===null){var o={hasValue:!1,value:null};r.current=o}else o=r.current;r=h2(function(){function c(g){if(!u){if(u=!0,d=g,g=a(g),t!==void 0&&o.hasValue){var w=o.value;if(t(w,g))return p=w}return p=g}if(w=p,g2(d,g))return w;var y=a(g);return t!==void 0&&t(w,y)?w:(d=g,p=y)}var u=!1,d,p,h=i===void 0?null:i;return[function(){return c(n())},h===null?void 0:function(){return c(h())}]},[n,i,a,t]);var s=p2(e,r[0],r[1]);return m2(function(){o.hasValue=!0,o.value=s},[s]),v2(s),s};Wf.exports=Uf;var w2=Wf.exports,Qe="default"in Tl?Ki:Tl,Ou=Symbol.for("react-redux-context"),Nu=typeof globalThis<"u"?globalThis:{};function R2(){if(!Qe.createContext)return{};const e=Nu[Ou]??(Nu[Ou]=new Map);let n=e.get(Qe.createContext);return n||(n=Qe.createContext(null),e.set(Qe.createContext,n)),n}var di=R2(),j2=()=>{throw new Error("uSES not initialized!")};function Ac(e=di){return function(){return Qe.useContext(e)}}var Qf=Ac(),qf=j2,y2=e=>{qf=e},x2=(e,n)=>e===n;function k2(e=di){const n=e===di?Qf:Ac(e),i=(a,t={})=>{const{equalityFn:r=x2,devModeChecks:o={}}=typeof t=="function"?{equalityFn:t}:t,{store:s,subscription:c,getServerState:u,stabilityCheck:d,identityFunctionCheck:p}=n();Qe.useRef(!0);const h=Qe.useCallback({[a.name](w){return a(w)}}[a.name],[a,d,o.stabilityCheck]),g=qf(c.addNestedSub,s.getState,u||s.getState,h,r);return Qe.useDebugValue(g),g};return Object.assign(i,{withTypes:()=>i}),i}var P=k2();function P2(e){e()}function C2(){let e=null,n=null;return{clear(){e=null,n=null},notify(){P2(()=>{let i=e;for(;i;)i.callback(),i=i.next})},get(){const i=[];let a=e;for(;a;)i.push(a),a=a.next;return i},subscribe(i){let a=!0;const t=n={callback:i,next:null,prev:n};return t.prev?t.prev.next=t:e=t,function(){!a||e===null||(a=!1,t.next?t.next.prev=t.prev:n=t.prev,t.prev?t.prev.next=t.next:e=t.next)}}}}var Mu={notify(){},get:()=>[]};function L2(e,n){let i,a=Mu,t=0,r=!1;function o(y){d();const x=a.subscribe(y);let v=!1;return()=>{v||(v=!0,x(),p())}}function s(){a.notify()}function c(){w.onStateChange&&w.onStateChange()}function u(){return r}function d(){t++,i||(i=e.subscribe(c),a=C2())}function p(){t--,i&&t===0&&(i(),i=void 0,a.clear(),a=Mu)}function h(){r||(r=!0,d())}function g(){r&&(r=!1,p())}const w={addNestedSub:o,notifyNestedSubs:s,handleChangeWrapper:c,isSubscribed:u,trySubscribe:h,tryUnsubscribe:g,getListeners:()=>a};return w}var K2=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u",b2=typeof navigator<"u"&&navigator.product==="ReactNative",T2=K2||b2?Qe.useLayoutEffect:Qe.useEffect;function $2({store:e,context:n,children:i,serverState:a,stabilityCheck:t="once",identityFunctionCheck:r="once"}){const o=Qe.useMemo(()=>{const u=L2(e);return{store:e,subscription:u,getServerState:a?()=>a:void 0,stabilityCheck:t,identityFunctionCheck:r}},[e,a,t,r]),s=Qe.useMemo(()=>e.getState(),[e]);T2(()=>{const{subscription:u}=o;return u.onStateChange=u.notifyNestedSubs,u.trySubscribe(),s!==e.getState()&&u.notifyNestedSubs(),()=>{u.tryUnsubscribe(),u.onStateChange=void 0}},[o,s]);const c=n||di;return Qe.createElement(c.Provider,{value:o},i)}var S2=$2;function Zf(e=di){const n=e===di?Qf:Ac(e),i=()=>{const{store:a}=n();return a};return Object.assign(i,{withTypes:()=>i}),i}var O2=Zf();function N2(e=di){const n=e===di?O2:Zf(e),i=()=>n().dispatch;return Object.assign(i,{withTypes:()=>i}),i}var He=N2();y2(w2.useSyncExternalStoreWithSelector);var Yf={exports:{}},M2="SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED",E2=M2,H2=E2;function Gf(){}function Xf(){}Xf.resetWarningCache=Gf;var D2=function(){function e(a,t,r,o,s,c){if(c!==H2){var u=new Error("Calling PropTypes validators directly is not supported by the `prop-types` package. Use PropTypes.checkPropTypes() to call them. Read more at http://fb.me/use-check-prop-types");throw u.name="Invariant Violation",u}}e.isRequired=e;function n(){return e}var i={array:e,bigint:e,bool:e,func:e,number:e,object:e,string:e,symbol:e,any:e,arrayOf:n,element:e,elementType:e,instanceOf:n,node:e,objectOf:n,oneOf:n,oneOfType:n,shape:n,exact:n,checkPropTypes:Xf,resetWarningCache:Gf};return i.PropTypes=i,i};Yf.exports=D2();var J2=Yf.exports;const M=Yu(J2),z2=j.nav`
...
`,Or=({difficulte:e,icon:n,children:i,selectedDifficulte:a,setSelectedDifficulte:t})=>{const r=He(),{fontColor:o,mainBgColor:s}=P(f=>f.mode),{color:c}=P(f=>f.color),u=a===e,[d,p]=K.useState(u?s:c),[h,g]=K.useState(u?c:s),[w,y]=K.useState(u?c:"#F7F7F2"),[x,v]=K.useState(u?s:o),m=()=>{t(e),r(jm(e))};return K.useEffect(()=>{p(u?s:c),g(u?c:s),y(u?c:"#F7F7F2"),v(u?s:o)},[u,s,c,o]),l.jsxs(Pj,{$mainBgColor:h,$fontColor:x,onClick:m,children:[l.jsxs(Cj,{children:[l.jsx("img",{src:n}),l.jsx("span",{children:e})]}),l.jsx(Lj,{$mainBgColor:w,$color:d,children:i})]})};Or.propTypes={difficulte:M.string.isRequired,icon:M.string.isRequired,children:M.node,selectedDifficulte:M.string.isRequired,setSelectedDifficulte:M.func.isRequired};function Jt(){const{bgColor:e,fontColor:n,mainBgColor:i}=P(v=>v.mode),{color:a}=P(v=>v.color),t=He(),[r,o]=K.useState(P(v=>v.parametersExercice.exerciceTimer)),[s,c]=K.useState(P(v=>v.parametersExercice.exerciceTimerActive)),[u,d]=K.useState("#858585"),[p,h]=K.useState("");K.useEffect(()=>{t(Vw(r))},[r,t]);const g=()=>{const v=!s;c(v),t(Ww(v)),d(v?a:"#858585")},w=()=>{r<15&&o(r+1)},y=()=>{r>1&&o(r-1)},x=window.innerWidth<560?"15vw":"5vw";return l.jsxs(gj,{id:"SectionDifficulte",children:[l.jsx(pj,{$bgColor:e,children:l.jsxs(fj,{$mainBgColor:i,$fontColor:n,children:[l.jsx("span",{children:"Temps par question"}),l.jsxs(mj,{$color:a,children:[l.jsx("button",{onClick:w,children:l.jsx(zs,{width:x,height:x,color:a})}),l.jsxs("p",{children:[r,l.jsx("span",{children:"S"})]}),l.jsx("button",{onClick:y,children:l.jsx(zs,{width:x,height:x,color:a})})]}),l.jsx(hj,{onClick:g,$color:u,children:s?"Activer":"Désactiver"})]})}),l.jsxs(vj,{$bgColor:e,children:[l.jsxs(wj,{children:[l.jsx(Rj,{$mainBgColor:i,$fontColor:n,children:"Difficulté"}),l.jsxs(jj,{$color:a,children:[l.jsxs(yj,{children:[l.jsx("span",{children:"こん"}),l.jsx("span",{children:"なん"})]}),l.jsxs(xj,{children:[l.jsx("span",{children:"困"}),l.jsx("span",{children:"難"})]})]})]}),l.jsxs(kj,{children:[l.jsxs(Or,{difficulte:"Débutant",icon:cj,selectedDifficulte:p,setSelectedDifficulte:h,children:[l.jsx("span",{children:"Hiragana/Katakana"}),l.jsx("span",{children:"Rōmaji"})]}),l.jsx(Or,{difficulte:"Intermédiaire",icon:dj,selectedDifficulte:p,setSelectedDifficulte:h,children:l.jsx("span",{children:"Hiragana/Katakana"})}),l.jsx(Or,{difficulte:"Confirmer",icon:uj,selectedDifficulte:p,setSelectedDifficulte:h})]})]})]})}const Io="data:image/svg+xml,%3csvg%20width='68'%20height='69'%20viewBox='0%200%2068%2069'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3crect%20x='19.5039'%20y='15.0544'%20width='48'%20height='7'%20rx='3'%20transform='rotate(45%2019.5039%2015.0544)'%20fill='%23F7F7F2'/%3e%3crect%20x='14.5542'%20y='48.9956'%20width='48'%20height='7'%20rx='3'%20transform='rotate(-45%2014.5542%2048.9956)'%20fill='%23F7F7F2'/%3e%3c/svg%3e",Kj=j.div`
    display: flex;
    width: calc(100% - 3vw);
    margin-right: 3vw;
    gap: 1vw;
...
`;function zt(){const{bgColor:e,fontColor:n,mainBgColor:i}=P(f=>f.mode),{color:a}=P(f=>f.color),t=He(),r=ge(),[o,s]=K.useState(null),u=(()=>{switch(r.pathname){case"/Kanji":return{modeTitle:"Kanji"};case"/Hiragana":return{modeTitle:"Hiragana"};case"/Katakana":return{modeTitle:"Katakana"};case"/Vocabulaire":return{modeTitle:"Vocabulaire"};case"/Nombres":return{modeTitle:"Nombres"};default:return"Accueil"}})(),d=fi(),p=f=>{t(mo(f)),s(f)},h=f=>o===f?a:i,g=P(f=>f.parametersExercice.exerciceNumber),w=g===0,y=f=>{if(document.querySelector(".Alert").style.display="block",g===0){x(".AlertNbQuestion",w);return}else t(mo(f)),d(`/choisir-ses/${u.modeTitle}`),window.scrollTo(0,0)},x=(f,R)=>{document.querySelector(f).style.display=R?"flex":"none"},v=()=>{document.querySelector(".NbAlert").style.display="none",x(".NbAlertNbQuestion",!1)},m=f=>()=>{const R=document.getElementById(`Section${f}`);R?(document.querySelector(".NbAlert").style.display="none",window.innerWidth<=560?R.scrollIntoView({behavior:"smooth",block:"start"}):R.scrollIntoView({behavior:"smooth",block:"center"})):console.error(`Element not found: #Section${f}`)};return l.jsxs(Kj,{id:"SectionModeDeJeu",children:[l.jsx(Oj,{className:"NbAlert",children:l.jsxs(Nj,{children:[l.jsx(Mj,{onClick:v,$color:a,children:l.jsx("img",{src:Io})}),l.jsxs(Ej,{onClick:m("NombreDeQuestions"),className:"NbAlertNbQuestion",$bgColor:e,$mainBgColor:i,$color:a,$fontColor:n,children:[l.jsxs("h1",{children:["Selectionner un ",l.jsx("span",{children:"nombre de questions"})]}),l.jsxs("div",{children:[l.jsx("p",{children:"Sélectionner le nombre de questions qui vous sera posée lors de l'exercice"}),l.jsx("span",{})]})]})]})}),l.jsx(Cl,{$bgColor:e,onClick:()=>p("Aléatoire"),children:l.jsxs(Ll,{$mainBgColor:h("Aléatoire"),$fontColor:n,children:[l.jsx(Kl,{$color:a,children:"Mode de jeu"}),l.jsxs(bj,{children:[l.jsx("span",{children:"ランダム"}),l.jsx("span",{children:"Aléatoire"})]})]})}),r.pathname.includes("/Vocabulaire")||r.pathname.includes("/Kanji")?l.jsx(Cl,{$bgColor:e,onClick:()=>p("N5"),children:l.jsxs(Ll,{$mainBgColor:h("N5"),$fontColor:n,children:[l.jsx(Kl,{$color:a,children:"Mode de jeu"}),l.jsx(Tj,{children:"N5"}),l.jsx($j,{children:"JLPT"})]})}):null,l.jsx(Cl,{$bgColor:e,onClick:()=>y("Choisir ses questions"),children:l.jsxs(Ll,{$mainBgColor:h("Choisir ses questions"),$fontColor:n,children:[l.jsx(Kl,{$color:a,children:"Mode de jeu"}),l.jsxs(Sj,{children:["Choisir ses ",u.modeTitle]})]})})]})}const Hj=j.div`
    display: flex;
    width: calc(100% - 5vw);
    height: 20vw;
    padding: 1vw;
...
`;function Dm({onReload:e}){const n=fi(),{bgColor:i,fontColor:a,mainBgColor:t}=P(f=>f.mode),{color:r}=P(f=>f.color),o=P(f=>f.parametersExercice.exerciceModeDeJeu),s=P(f=>f.parametersExercice.exerciceNumber),c=P(f=>f.parametersExercice.exerciceDifficulté),u=P(f=>f.parametersExercice.exerciceTimer),d=P(f=>f.exercice.totalTimer),p=P(f=>f.parametersExercice.exerciceTimerActive),h=P(f=>f.exercice.totalfaute),g=P(f=>f.exercice.questionsIncorrectes),[w,y]=K.useState(null),v=(f=>{const R=Math.floor(f/60),k=f%60,C=R.toString().padStart(2,"0"),L=k.toString().padStart(2,"0");return`${C}:${L}`})(d);if(!g)return l.jsx("div",{children:"Loading..."});const m=window.innerWidth<=560?"7vw":"2.5vw";return l.jsxs(S5,{$mainBgColor:t,children:[l.jsxs(O5,{$bgColor:i,children:[l.jsxs(N5,{$mainBgColor:t,$fontColor:a,$color:r,children:[l.jsx("p",{children:"Difficulté"}),l.jsx("p",{children:c})]}),l.jsxs(M5,{$mainBgColor:t,$fontColor:a,$color:r,children:[l.jsx("p",{children:"Nombre de Kanji "}),l.jsx("p",{children:s})]}),l.jsxs(E5,{$mainBgColor:t,$fontColor:a,$color:r,children:[l.jsx("p",{children:"Mode de jeu"}),l.jsx("p",{children:o})]}),l.jsx(H5,{$mainBgColor:t,$fontColor:a,$color:r,children:w&&l.jsxs("div",{children:[l.jsx("h3",{children:w.kanji||w.Dakuten||w.Handakuten||w.hiragana||w.Hiragana||w.Katakana||w.Kanji}),l.jsxs("div",{children:[w.Romaji&&l.jsxs("p",{children:[l.jsx("span",{children:"Romaji "})," ",w.Romaji]}),w.francais&&l.jsxs("p",{children:[l.jsx("span",{children:"Francais "})," ",w.francais]}),w.hiragana&&l.jsxs("p",{children:[l.jsx("span",{children:"Hiragana "})," ",w.hiragana]}),w.OnPrincipalReading&&l.jsxs("p",{children:[l.jsx("span",{children:"On "})," ",w.OnPrincipalReading]}),w.KunPrincipalReading&&l.jsxs("p",{children:[l.jsx("span",{children:"Kun "})," ",w.KunPrincipalReading]}),w.Meaning&&l.jsxs("p",{children:[l.jsx("span",{children:"Francais "})," ",w.Meaning]})]})]})}),l.jsx(D5,{$mainBgColor:t,$fontColor:a,$color:r,children:l.jsx("div",{children:g.length>0?g.filter(Boolean).map((f,R)=>l.jsx("p",{onMouseEnter:()=>y(f),children:f.kanji||(f.Nom==="Handakuten"?f.Handakuten:f.Nom==="Dakuten"?f.Dakuten:f.hiragana||f.Hiragana||f.Katakana||f.Kanji)},R)):l.jsx("p",{children:"pas de faute"})})}),l.jsxs(J5,{$mainBgColor:t,$fontColor:a,$color:r,children:[l.jsx("p",{children:"Erreur"}),l.jsx("p",{children:h})]}),l.jsx(z5,{$mainBgColor:t,$fontColor:a,$color:r,children:l.jsxs("p",{children:[p===!1?v:u,l.jsx("span",{children:"s"})]})}),l.jsx(F5,{$mainBgColor:t,$fontColor:a,$color:r,$bgColor:i,children:l.jsx("div",{})})]}),l.jsxs(_5,{$mainBgColor:t,$fontColor:a,$color:r,$bgColor:i,children:[l.jsxs("button",{onClick:e,children:[" ",l.jsx(Xc,{color:r,width:m,height:m,children:" "})]}),l.jsx("button",{onClick:()=>{e(),n(-1)},children:"Terminer"})]})]})}Dm.propTypes={onReload:M.func.isRequired};const A5=j.div`
    display: flex;
    flex-direction: column;
    align-items: center;
    width: 100%;
