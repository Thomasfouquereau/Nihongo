 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function n(M,z){var H=M.length;M.push(z);e:for(;0<H;){var J=H-1>>>1,B=M[J];if(0<t(B,z))M[J]=z,M[H]=B,H=J;else break e}}function i(M){return M.length===0?null:M[0]}function a(M){if(M.length===0)return null;var z=M[0],H=M.pop();if(H!==z){M[0]=H;e:for(var J=0,B=M.length,ee=B>>>1;J<ee;){var ge=2*(J+1)-1,ye=M[ge],ne=ge+1,rn=M[ne];if(0>t(ye,H))ne<B&&0>t(rn,ye)?(M[J]=rn,M[ne]=H,J=ne):(M[J]=ye,M[ge]=H,J=ge);else if(ne<B&&0>t(rn,H))M[J]=rn,M[ne]=H,J=ne;else break e}}return z}function t(M,z){var H=M.sortIndex-z.sortIndex;return H!==0?H:M.id-z.id}if(typeof performance=="object"&&typeof performance.now=="function"){var r=performance;e.unstable_now=function(){return r.now()}}else{var l=Date,s=l.now();e.unstable_now=function(){return l.now()-s}}var c=[],d=[],u=1,g=null,m=3,p=!1,x=!1,y=!1,k=typeof setTimeout=="function"?setTimeout:null,w=typeof clearTimeout=="function"?clearTimeout:null,f=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function v(M){for(var z=i(d);z!==null;){if(z.callback===null)a(d);else if(z.startTime<=M)a(d),z.sortIndex=z.expirationTime,n(c,z);else break;z=i(d)}}function j(M){if(y=!1,v(M),!x)if(i(c)!==null)x=!0,X(C);else{var z=i(d);z!==null&&le(j,z.startTime-M)}}function C(M,z){x=!1,y&&(y=!1,w(K),K=-1),p=!0;var H=m;try{for(v(z),g=i(c);g!==null&&(!(g.expirationTime>z)||M&&!xe());){var J=g.callback;if(typeof J=="function"){g.callback=null,m=g.priorityLevel;var B=J(g.expirationTime<=z);z=e.unstable_now(),typeof B=="function"?g.callback=B:g===i(c)&&a(c),v(z)}else a(c);g=i(c)}if(g!==null)var ee=!0;else{var ge=i(d);ge!==null&&le(j,ge.startTime-z),ee=!1}return ee}finally{g=null,m=H,p=!1}}var P=!1,b=null,K=-1,S=5,F=-1;function xe(){return!(e.unstable_now()-F<S)}function T(){if(b!==null){var M=e.unstable_now();F=M;var z=!0;try{z=b(!0,M)}finally{z?D():(P=!1,b=null)}}else P=!1}var D;if(typeof f=="function")D=function(){f(T)};else if(typeof MessageChannel<"u"){var U=new MessageChannel,Z=U.port2;U.port1.onmessage=T,D=function(){Z.postMessage(null)}}else D=function(){k(T,0)};function X(M){b=M,P||(P=!0,D())}function le(M,z){K=k(function(){M(e.unstable_now())},z)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(M){M.callback=null},e.unstable_continueExecution=function(){x||p||(x=!0,X(C))},e.unstable_forceFrameRate=function(M){0>M||125<M?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):S=0<M?Math.floor(1e3/M):5},e.unstable_getCurrentPriorityLevel=function(){return m},e.unstable_getFirstCallbackNode=function(){return i(c)},e.unstable_next=function(M){switch(m){case 1:case 2:case 3:var z=3;break;default:z=m}var H=m;m=z;try{return M()}finally{m=H}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(M,z){switch(M){case 1:case 2:case 3:case 4:case 5:break;default:M=3}var H=m;m=M;try{return z()}finally{m=H}},e.unstable_scheduleCallback=function(M,z,H){var J=e.unstable_now();switch(typeof H=="object"&&H!==null?(H=H.delay,H=typeof H=="number"&&0<H?J+H:J):H=J,M){case 1:var B=-1;break;case 2:B=250;break;case 5:B=1073741823;break;case 4:B=1e4;break;default:B=5e3}return B=H+B,M={id:u++,callback:z,priorityLevel:M,startTime:H,expirationTime:B,sortIndex:-1},H>J?(M.sortIndex=H,n(d,M),i(c)===null&&M===i(d)&&(y?(w(K),K=-1):y=!0,le(j,H-J))):(M.sortIndex=B,n(c,M),x||p||(x=!0,X(C))),M},e.unstable_shouldYield=xe,e.unstable_wrapCallback=function(M){var z=m;return function(){var H=m;m=z;try{return M.apply(this,arguments)}finally{m=H}}}})(Bg);Jg.exports=Bg;var sf=Jg.exports;/**
 * @license React
...
`,Vw=h.span`
    ...
    margin: 0;
    border-radius: 0.5vw;
`;function Uw(){const{bgColor:e,fontColor:n,mainBgColor:i}=R(d=>d.mode),{color:a}=R(d=>d.color),[t,r]=L.useState("日本"),[l,s]=L.useState(new Date().toLocaleTimeString("ja-JP",{timeZone:"Asia/Tokyo"}));L.useEffect(()=>{const d=setInterval(()=>{s(new Date().toLocaleTimeString(t==="フランス"?"fr-FR":"ja-JP",{timeZone:t==="フランス"?"Europe/Paris":"Asia/Tokyo",hour:"2-digit",minute:"2-digit"}))},10);return()=>clearInterval(d)},[t]);const c=d=>{r(d==="France"?"フランス":"日本")};return o.jsxs(_w,{$bgColor:e,$fontColor:n,children:[o.jsxs(Iw,{$mainBgColor:i,$fontColor:n,children:[o.jsx("button",{onClick:()=>c("France"),style:{backgroundColor:t==="フランス"?a:i},children:"France"}),o.jsx("button",{onClick:()=>c("Japon"),style:{backgroundColor:t==="日本"?a:i},children:"Japon"})]}),o.jsx(Aw,{$mainBgColor:i,children:t}),o.jsx(Vw,{$color:a,$mainBgColor:i,children:l})]})}const Xw=h.button`
    display: none;
    @media screen and (max-width: 560px) {
        background-color: ${e=>e.$color};
        color: #F7F7F2;
...
`;function Nm({onButtonClick:e,displayButton:n}){const{color:i}=R(t=>t.color),{bgColor:a}=R(t=>t.mode);return o.jsx(Xw,{$color:i,$bgColor:a,onClick:e,display:n,children:"Menu"})}Nm.propTypes={onButtonClick:$.func.isRequired,displayButton:$.string.isRequired};const Ao=({color:e,mainBgColor:n,width:i="5vw",height:a="5vw"})=>o.jsxs("svg",{width:i,height:a,viewBox:"0 0 74 70",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[o.jsx("rect",{y:"2",width:"36",height:"68",fill:e}),o.jsx("rect",{x:"41",y:"18",width:"3",height:"2",fill:e}),o.jsx("rect",{x:"60",y:"18",width:"3",height:"2",fill:e}),o.jsx("rect",{x:"29",width:"3",height:"2",fill:e}),o.jsx("rect",{x:"8",width:"3",height:"2",fill:e}),o.jsx("rect",{x:"38",y:"20",width:"36",height:"50",fill:e}),o.jsx("path",{d:"M54 61C54 59.8954 54.8954 59 56 59C57.1046 59 58 59.8954 58 61V70H54V61Z",fill:n}),o.jsx("path",{d:"M16 61C16 59.8954 16.8954 59 18 59C19.1046 59 20 59.8954 20 61V70H16V61Z",fill:n}),o.jsx("rect",{x:"4",y:"44",width:"4",height:"11",fill:n}),o.jsx("rect",{x:"4",y:"28",width:"4",height:"11",fill:n}),o.jsx("rect",{x:"42",y:"43",width:"4",height:"11",fill:n}),o.jsx("rect",{x:"4",y:"12",width:"4",height:"11",fill:n}),o.jsx("rect",{x:"42",y:"27",width:"4",height:"11",fill:n}),o.jsx("rect",{x:"10",y:"44",width:"4",height:"11",fill:n}),o.jsx("rect",{x:"10",y:"28",width:"4",height:"11",fill:n}),o.jsx("rect",{x:"48",y:"43",width:"4",height:"11",fill:n}),o.jsx("rect",{x:"10",y:"12",width:"4",height:"11",fill:n}),o.jsx("rect",{x:"48",y:"27",width:"4",height:"11",fill:n}),o.jsx("rect",{x:"16",y:"44",width:"4",height:"11",fill:n}),o.jsx("rect",{x:"16",y:"28",width:"4",height:"11",fill:n}),o.jsx("rect",{x:"54",y:"43",width:"4",height:"11",fill:n}),o.jsx("rect",{x:"16",y:"12",width:"4",height:"11",fill:n}),o.jsx("rect",{x:"54",y:"27",width:"4",height:"11",fill:n}),o.jsx("rect",{x:"22",y:"44",width:"4",height:"11",fill:n}),o.jsx("rect",{x:"22",y:"58",width:"10",height:"11",fill:n}),o.jsx("rect",{x:"42",y:"58",width:"10",height:"11",fill:n}),o.jsx("rect",{x:"60",y:"58",width:"10",height:"11",fill:n}),o.jsx("rect",{x:"4",y:"58",width:"10",height:"11",fill:n}),o.jsx("rect",{x:"22",y:"28",width:"4",height:"11",fill:n}),o.jsx("rect",{x:"60",y:"43",width:"4",height:"11",fill:n}),o.jsx("rect",{x:"22",y:"12",width:"4",height:"11",fill:n}),o.jsx("rect",{x:"60",y:"27",width:"4",height:"11",fill:n}),o.jsx("rect",{x:"28",y:"44",width:"4",height:"11",fill:n}),o.jsx("rect",{x:"28",y:"28",width:"4",height:"11",fill:n}),o.jsx("rect",{x:"66",y:"43",width:"4",height:"11",fill:n}),o.jsx("rect",{x:"28",y:"12",width:"4",height:"11",fill:n}),o.jsx("rect",{x:"66",y:"27",width:"4",height:"11",fill:n})]});Ao.propTypes={color:$.string,mainBgColor:$.string,width:$.string,height:$.string};const Ai="data:image/svg+xml,%3csvg%20width='68'%20height='69'%20viewBox='0%200%2068%2069'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3crect%20x='19.5039'%20y='15.0544'%20width='48'%20height='7'%20rx='3'%20transform='rotate(45%2019.5039%2015.0544)'%20fill='%23F7F7F2'/%3e%3crect%20x='14.5542'%20y='48.9956'%20width='48'%20height='7'%20rx='3'%20transform='rotate(-45%2014.5542%2048.9956)'%20fill='%23F7F7F2'/%3e%3c/svg%3e",qw=h.div`
    display: flex;
    flex-direction: column;
    position: absolute;
    right: 3vw;
...
`;function Ix(){const e=R(l=>l.mode),{color:n}=R(l=>l.color),{bgColor:i}=R(l=>l.mode),a=window.innerWidth<560?"9vw":"3vw",t=localStorage.getItem("userLvL");let r="lock";return t>="3"&&(r="unlock"),o.jsxs(Jx,{children:[o.jsx(Dx,{}),o.jsxs(Bx,{$bgColor:i,to:r==="lock"?"#":"/custom-nav",$disabled:r==="lock",children:[o.jsx("img",{src:e.mode==="light"?dh:uh}),r==="lock"&&o.jsx(_x,{children:o.jsx(Ji,{color:n,width:a,height:a})})]})]})}const Ax=()=>{const{mainBgColor:e}=R(n=>n.mode);return L.useEffect(()=>{document.body.style.backgroundColor=e},[e]),null},Vx=h.div`
    display: flex;
    width: 100%;
    gap: 1vw;
    height: 6.5vw;
...
`;function il(){const{bgColor:e,fontColor:n,mainBgColor:i}=R(w=>w.mode),{color:a}=R(w=>w.color),t=localStorage.getItem("mode")||"light",r=window.innerWidth<=560?"10vw":"3vw",l=Ne(),s=oe(),c=window.innerWidth<=560?"15vw":"4vw",d=w=>{window.scrollTo({top:document.querySelector("#exercice").offsetTop,behavior:"smooth"});const v={"Premier pas":{difficulté:"Débutant",number:10,typeDeKana:"normal",modeDeJeu:"N5"},Découverte:{difficulté:"Débutant",number:20,typeDeKana:"normal",modeDeJeu:"N5"},"Développement Avancé":{difficulté:"Intermédiaire",number:20,typeDeKana:"tout",modeDeJeu:"Aléatoire"},"Mises à Jour":{difficulté:"Confirmé",number:30,typeDeKana:"tout",modeDeJeu:"Aléatoire"}}[w];v&&(l(nh(v.difficulté)),l(ih(v.number)),l(ud(v.typeDeKana)),s.pathname==="/Hiragana"||s.pathname==="/Nihongo-V2/Hiragana"||s.pathname==="/Katakana"||s.pathname==="/Nihongo-V2/Katakana"?l(pa("Aléatoire")):l(pa(v.modeDeJeu)))},u=localStorage.getItem("hiraganaLvL"),g=localStorage.getItem("katakanaLvL"),m=localStorage.getItem("kanjiLvL"),p=localStorage.getItem("vocabulaireLvL"),x=localStorage.getItem("nombreLvL");let y="lock",k="lock";switch(s.pathname){case"/Hiragana":u>="3"&&(y="unlock"),u>="7"&&(k="unlock");break;case"/Katakana":g>="3"&&(y="unlock"),g>="7"&&(k="unlock");break;case"/Kanji":m>="3"&&(y="unlock"),m>="7"&&(k="unlock");break;case"/Vocabulaire":p>="3"&&(y="unlock"),p>="7"&&(k="unlock");break;case"/Nombre":x>="3"&&(y="unlock"),x>="7"&&(k="unlock");break}return o.jsxs(V3,{$bgColor:e,children:[o.jsxs(U3,{$fontColor:n,$mainBgColor:i,$color:a,children:[o.jsx("p",{children:"Prereglage Exercices"}),o.jsxs(X3,{children:[o.jsxs(q3,{$fontColor:n,$mainBgColor:i,$color:a,children:[o.jsxs("div",{children:[o.jsx("button",{children:o.jsx(gh,{width:r,height:r,color:a,mainColor:i})}),o.jsx("button",{children:o.jsx("img",{src:t==="light"?ph:Ai})})]}),o.jsx("button",{children:o.jsx("span",{children:"Créer"})})]}),o.jsxs(W3,{$fontColor:n,$mainBgColor:i,$color:a,children:[o.jsx("div",{}),o.jsx("div",{})]})]})]}),o.jsxs(Q3,{children:[o.jsxs(vr,{onClick:()=>d("Premier pas"),$fontColor:n,$mainBgColor:i,$color:a,children:[o.jsx("h3",{children:"Premier pas"}),o.jsx("p",{children:"Parfait pour découvrir"}),o.jsx("img",{src:mh})]}),o.jsxs(vr,{onClick:()=>d("Découverte"),$fontColor:n,$mainBgColor:i,$color:a,children:[o.jsx("h3",{children:"Découverte"}),o.jsx("p",{children:"Parfait pour en apprendre plus"}),o.jsx("img",{src:I3})]}),o.jsxs(vr,{onClick:()=>y==="unlock"&&d("Développement Avancé"),$fontColor:n,$mainBgColor:i,$color:a,children:[o.jsx("h3",{children:"Développement Avancé"}),o.jsx("p",{children:"Parfait pour développer ses compétences"}),o.jsx("img",{src:hh}),y==="lock"&&o.jsx(vg,{$lvl:"lvl 3",children:o.jsx(Ji,{color:a,width:c,height:c})})]}),o.jsxs(vr,{onClick:()=>k==="unlock"&&d("Mises à Jour"),$fontColor:n,$mainBgColor:i,$color:a,children:[o.jsx("h3",{children:"Mises à Jour"}),o.jsx("p",{children:"Parfait pour continue à se perfectionner"}),o.jsx("img",{src:A3}),k==="lock"&&o.jsx(vg,{$lvl:"lvl 7",children:o.jsx(Ji,{color:a,width:c,height:c})})]})]})]})}const Z3=h.header`
    display: flex;
    flex-direction: column;
    gap: 1vw;
    margin-left: 3vw;
...
`;function qy(){const{bgColor:e}=R(n=>n.mode);return o.jsxs(Uy,{$bgColor:e,children:[o.jsx(Ay,{}),o.jsxs(Xy,{children:[o.jsx(Rg,{}),o.jsx(Rg,{})]})]})}const Wy=h.div`
    display: flex;
    justify-content: center;
    align-items: center;
    gap: 0.5vw;
...
`;function Vk(){const{mainBgColor:e,fontColor:n,bgColor:i}=R(l=>l.mode),{color:a}=R(l=>l.color),t=window.innerWidth<560?"14vw":"5vw",r=pn();return o.jsx(Ik,{$bgColor:i,children:o.jsxs(Ak,{$mainBgColor:e,$fontColor:n,onClick:()=>r(-1),children:[o.jsx(Zo,{width:t,height:t,color:a}),o.jsxs("div",{children:[o.jsx("span",{children:"もど"}),o.jsx("span",{children:"戻る"}),o.jsx("span",{children:"Retour"})]})]})})}const Uk=h.div`
    display: flex;
    gap: 0.8vw;
    padding: 1vw;
    background-color: ${e=>e.$bgColor};
...
`;function Lh(){const{bgColor:e,fontColor:n,mainBgColor:i}=R(l=>l.mode),{color:a}=R(l=>l.color),t=window.innerWidth<=560?"7vw":"2vw";let r=pn();return o.jsx(S6,{children:o.jsxs(O6,{$bgColor:e,children:[o.jsxs(M6,{$fontColor:n,$mainBgColor:i,children:[o.jsx(Zo,{color:a,width:t,height:t}),o.jsx(W,{onClick:()=>r(-1),children:"Retour"})]}),o.jsx(z6,{to:"/",$mainBgColor:i,children:o.jsx(Ao,{color:a,mainBgColor:i,width:t,height:t})})]})})}const E6=h.div`
    display: flex;
    gap: 1vw;
    width: 94%;
    @media screen and (max-width: 560px){
...
`;function V6(){return o.jsxs(I6,{children:[o.jsx(Lh,{}),o.jsx(_6,{}),o.jsx(A6,{children:Qo.map(e=>o.jsx(gd,{article:e},e.id))})]})}const U6=h.div`
    display: flex;
    width: 92%;
    padding: 1vw;
    background-color: ${e=>e.$bgColor};
...
`;function Oh(){const{id:e}=qp(),[n,i]=L.useState(null);return L.useEffect(()=>{const a=Qo.find(t=>t.id===parseInt(e));i(a)},[e]),n?o.jsxs(a4,{children:[o.jsx(Lh,{}),o.jsx(Kh,{article:n}),o.jsx($h,{article:n}),o.jsx(Th,{article:n}),o.jsx(Sh,{article:n})]}):o.jsx("div",{children:"Loading..."})}Oh.propTypes={article:$.object};function Mh({question:e,isCorrect:n,reponseArray:i}){return o.jsxs("div",{children:[o.jsx("p",{children:e.questionInFrench||null}),e.type==="Type1"?o.jsxs("div",{children:[e.questionPart1,o.jsx("span",{style:{backgroundColor:"lightblue",padding:"0.5rem"},children:i.map((a,t)=>o.jsx("span",{children:a},t))}),e.questionPart2]}):e.type==="Type2"?o.jsxs("div",{style:{display:"flex"},children:[o.jsx("div",{children:o.jsx("span",{style:{backgroundColor:"lightblue",padding:"0.5rem"},children:i[0]})}),o.jsx("p",{children:e.question}),o.jsx("div",{children:o.jsx("span",{style:{backgroundColor:"lightblue",padding:"0.5rem"},children:i[1]})})]}):null]})}Mh.propTypes={question:$.object.isRequired,isCorrect:$.bool,allIsCorrect:$.bool,reponseArray:$.array.isRequired};function zh({question:e,onReponseClick:n,reponseArray:i}){const[a,t]=L.useState(e.reponseProposee);L.useEffect(()=>{i.length===0&&t(e.reponseProposee)},[i,e.reponseProposee]),(s=>{for(let c=s.length-1;c>0;c--){const d=Math.floor(Math.random()*(c+1));[s[c],s[d]]=[s[d],s[c]]}})(a);const l=s=>{n(s),t(a.filter(c=>c!==s))};return o.jsx("div",{children:a.map((s,c)=>o.jsx("span",{style:{margin:"0.5rem",padding:"0.5rem",backgroundColor:"lightgrey",cursor:"pointer"},onClick:()=>l(s),children:s},c))})}zh.propTypes={question:$.object.isRequired,onReponseClick:$.func.isRequired,reponseArray:$.array.isRequired};function Eh({article:e}){const[n,i]=L.useState(0),[a,t]=L.useState(null),[r,l]=L.useState([]),[s,c]=L.useState([]),d=oe();if(L.useEffect(()=>{const p=new URLSearchParams(d.search).get("difficulty"),x=e.exercises.questions.filter(y=>y.question.difficulty===p);l(x)},[d.search,e.exercises.questions]),L.useEffect(()=>{a===!0?setTimeout(()=>{i(m=>m+1),console.log("correct"),t(null),c([])},1e3):a===!1&&setTimeout(()=>{t(null)},1e3)},[a]),n>=r.length)return o.jsx("div",{children:"Vous avez terminé tous les exercices de ce niveau!"});const u=r[n].question,g=m=>{c(p=>{const x=[...p,m];return x.length===2&&(x[0]===u.reponse1&&x[1]===u.reponse2?t(!0):(t(!1),setTimeout(()=>{c(k=>k.filter(w=>w===u.reponse1||w===u.reponse2))},1e3))),x})};return o.jsxs("div",{children:[o.jsx(Mh,{question:u,isCorrect:a,reponseArray:s}),o.jsx(zh,{question:u,onReponseClick:g,reponseArray:s})]})}Eh.propTypes={article:$.object.isRequired};const t4=h.div`
    display: flex;
    background-color: ${e=>e.$bgColor};
    flex-direction: column;
    align-items: center;
