...
`;function Om({onReload:e}){const n=fi(),{bgColor:i,fontColor:a,mainBgColor:t}=P(f=>f.mode),{color:r}=P(f=>f.color),o=P(f=>f.parametersExercice.exerciceModeDeJeu),s=P(f=>f.parametersExercice.exerciceNumber),c=P(f=>f.parametersExercice.exerciceDifficulté),u=P(f=>f.parametersExercice.exerciceTimer),d=P(f=>f.exercice.totalTimer),p=P(f=>f.parametersExercice.exerciceTimerActive),h=P(f=>f.exercice.totalfaute),g=P(f=>f.exercice.questionsIncorrectes),[w,y]=K.useState(null),v=(f=>{const R=Math.floor(f/60),k=f%60,C=R.toString().padStart(2,"0"),L=k.toString().padStart(2,"0");return`${C}:${L}`})(d);if(!g)return l.jsx("div",{children:"Loading..."});const m=window.innerWidth<=560?"7vw":"2.5vw";return l.jsxs(P5,{$mainBgColor:t,children:[l.jsxs(C5,{$bgColor:i,children:[l.jsxs(L5,{$mainBgColor:t,$fontColor:a,$color:r,children:[l.jsx("p",{children:"Difficulté"}),l.jsx("p",{children:c})]}),l.jsxs(K5,{$mainBgColor:t,$fontColor:a,$color:r,children:[l.jsx("p",{children:"Nombre de Kanji "}),l.jsx("p",{children:s})]}),l.jsxs(b5,{$mainBgColor:t,$fontColor:a,$color:r,children:[l.jsx("p",{children:"Mode de jeu"}),l.jsx("p",{children:o})]}),l.jsx(T5,{$mainBgColor:t,$fontColor:a,$color:r,children:w&&l.jsxs("div",{children:[l.jsx("h3",{children:w.kanji||w.Dakuten||w.Handakuten||w.hiragana||w.Hiragana||w.Katakana||w.Kanji}),l.jsxs("div",{children:[w.Romaji&&l.jsxs("p",{children:[l.jsx("span",{children:"Romaji "})," ",w.Romaji]}),w.francais&&l.jsxs("p",{children:[l.jsx("span",{children:"Francais "})," ",w.francais]}),w.hiragana&&l.jsxs("p",{children:[l.jsx("span",{children:"Hiragana "})," ",w.hiragana]}),w.OnPrincipalReading&&l.jsxs("p",{children:[l.jsx("span",{children:"On "})," ",w.OnPrincipalReading]}),w.KunPrincipalReading&&l.jsxs("p",{children:[l.jsx("span",{children:"Kun "})," ",w.KunPrincipalReading]}),w.Meaning&&l.jsxs("p",{children:[l.jsx("span",{children:"Francais "})," ",w.Meaning]})]})]})}),l.jsx($5,{$mainBgColor:t,$fontColor:a,$color:r,children:l.jsx("div",{children:g.length>0?g.filter(Boolean).map((f,R)=>l.jsx("p",{onMouseEnter:()=>y(f),children:f.kanji||(f.Nom==="Handakuten"?f.Handakuten:f.Nom==="Dakuten"?f.Dakuten:f.hiragana||f.Hiragana||f.Katakana||f.Kanji)},R)):l.jsx("p",{children:"pas de faute"})})}),l.jsxs(S5,{$mainBgColor:t,$fontColor:a,$color:r,children:[l.jsx("p",{children:"Erreur"}),l.jsx("p",{children:h})]}),l.jsx(O5,{$mainBgColor:t,$fontColor:a,$color:r,children:l.jsxs("p",{children:[p===!1?v:u,l.jsx("span",{children:"s"})]})}),l.jsx(N5,{$mainBgColor:t,$fontColor:a,$color:r,$bgColor:i,children:l.jsx("div",{})})]}),l.jsxs(M5,{$mainBgColor:t,$fontColor:a,$color:r,$bgColor:i,children:[l.jsxs("button",{onClick:e,children:[" ",l.jsx(qc,{color:r,width:m,height:m,children:" "})]}),l.jsx("button",{onClick:()=>{e(),n(-1)},children:"Terminer"})]})]})}Om.propTypes={onReload:M.func.isRequired};const E5=j.div`
    display: flex;
    flex-direction: column;
    align-items: center;
    width: 100%;
...
`;function B5(){const{bgColor:e}=P(n=>n.mode);return l.jsxs(F5,{$bgColor:e,children:[l.jsx(z5,{}),l.jsxs(A5,{children:[l.jsx(Uu,{}),l.jsx(Uu,{})]})]})}const I5=j.div`
    display: flex;
    justify-content: center;
    align-items: center;
    gap: 0.5vw;
...
`;function V5(){const{bgColor:e,fontColor:n,mainBgColor:i}=P(s=>s.mode),a=P(s=>s.exercice.totalfaute),t=P(s=>s.exercice.totalreussite),r=P(s=>s.parametersExercice.exerciceNumber),o=t+a;return l.jsxs(I5,{$mainBgColor:i,$bgColor:e,$fontColor:n,children:[l.jsx("p",{children:t}),l.jsxs("p",{children:[o,"/",r]}),l.jsx("p",{children:a})]})}function W5(){return l.jsx("div",{})}const U5=j.div`
    display: flex;
    align-items: center;
...
`;function Q5(){return l.jsxs(U5,{children:[l.jsx(V5,{}),location.pathname==="/Exercices/Katakana"||location.pathname==="/Exercices/Hiragana"||location.pathname==="/Exercices/Kanji"&&l.jsx(W5,{})]})}const q5=j.div`
    display: flex;
    align-items: center;
    flex-direction: column;
    justify-content: center;
...
`;function Z5(){return l.jsxs(q5,{children:[l.jsx(Q5,{}),l.jsx(B5,{})]})}const Y5="/Nihongo-V2/",G5=Ll.createRoot(document.getElementById("root"));G5.render(l.jsx(L2,{store:eR,children:l.jsxs(e1,{basename:Y5,children:[l.jsx(gR,{}),l.jsxs(Uv,{children:[l.jsx(an,{path:"/",element:l.jsx(AR,{})}),l.jsx(an,{path:"/kanji",element:l.jsx(ay,{})}),l.jsx(an,{path:"/vocabulaire",element:l.jsx(ry,{})}),l.jsx(an,{path:"/katakana",element:l.jsx(sy,{})}),l.jsx(an,{path:"/hiragana",element:l.jsx(dy,{})}),l.jsx(an,{path:"/nombres",element:l.jsx(gy,{})}),l.jsx(an,{path:"/dictionnaire/*",element:l.jsx(s5,{})}),l.jsx(an,{path:"/choisir-ses/*",element:l.jsx(R5,{})}),l.jsx(an,{path:"/color",element:l.jsx(vR,{})}),l.jsx(an,{path:"/exercices/*",element:l.jsx(Z5,{})}),l.jsx(an,{path:"*",element:l.jsx(fR,{})})]})]})}));
