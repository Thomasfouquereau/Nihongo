...
`,n5=j.span`
    ...
    margin: 0;
    border-radius: 0.5vw;
`;function i5(){const{bgColor:e,fontColor:n,mainBgColor:i}=P(u=>u.mode),{color:a}=P(u=>u.color),[t,r]=K.useState("日本"),[o,s]=K.useState(new Date().toLocaleTimeString("ja-JP",{timeZone:"Asia/Tokyo"}));K.useEffect(()=>{const u=setInterval(()=>{s(new Date().toLocaleTimeString(t==="フランス"?"fr-FR":"ja-JP",{timeZone:t==="フランス"?"Europe/Paris":"Asia/Tokyo",hour:"2-digit",minute:"2-digit"}))},10);return()=>clearInterval(u)},[t]);const c=u=>{r(u==="France"?"フランス":"日本")};return l.jsxs(Gy,{$bgColor:e,$fontColor:n,children:[l.jsxs(Xy,{$mainBgColor:i,$fontColor:n,children:[l.jsx("button",{onClick:()=>c("France"),style:{backgroundColor:t==="フランス"?a:i},children:"France"}),l.jsx("button",{onClick:()=>c("Japon"),style:{backgroundColor:t==="日本"?a:i},children:"Japon"})]}),l.jsx(e5,{$mainBgColor:i,children:t}),l.jsx(n5,{$color:a,$mainBgColor:i,children:o})]})}const a5=j.button`
    display: none;
    @media screen and (max-width: 560px) {
        background-color: ${e=>e.$color};
        color: #F7F7F2;
   ...
   `;function bm({onButtonClick:e}){const{color:n}=P(a=>a.color),{mainBgColor:i}=P(a=>a.mode);return l.jsx(a5,{$color:n,$bgColor:i,onClick:e,children:"Menu"})}bm.propTypes={onButtonClick:M.func.isRequired};const t5=j.div`
    display: flex;
    flex-direction: column;
    position: absolute;
    right: 3vw;
...
`;function r5(){const[e,n]=K.useState(!1),i=()=>{n(!e),console.log("Button clicked!",e)},a=()=>{n(!1)};return l.jsxs(t5,{$clicked:e?"true":void 0,children:[l.jsx(Km,{isButtonClicked:e,onLinkClick:a}),l.jsx(i5,{}),l.jsx(bm,{onButtonClick:i})]})}const o5=j.div`
    display: flex;
    justify-content: center;
    align-items: center;
    width: 100%;
...
`;function Om({onReload:e}){const n=fi(),{bgColor:i,fontColor:a,mainBgColor:t}=P(f=>f.mode),{color:r}=P(f=>f.color),o=P(f=>f.parametersExercice.exerciceModeDeJeu),s=P(f=>f.parametersExercice.exerciceNumber),c=P(f=>f.parametersExercice.exerciceDifficulté),u=P(f=>f.parametersExercice.exerciceTimer),d=P(f=>f.exercice.totalTimer),p=P(f=>f.parametersExercice.exerciceTimerActive),h=P(f=>f.exercice.totalfaute),g=P(f=>f.exercice.questionsIncorrectes),[w,y]=K.useState(null),v=(f=>{const R=Math.floor(f/60),k=f%60,C=R.toString().padStart(2,"0"),L=k.toString().padStart(2,"0");return`${C}:${L}`})(d);if(!g)return l.jsx("div",{children:"Loading..."});const m=window.innerWidth<=560?"7vw":"2.5vw";return l.jsxs(d5,{$mainBgColor:t,children:[l.jsxs(u5,{$bgColor:i,children:[l.jsxs(g5,{$mainBgColor:t,$fontColor:a,$color:r,children:[l.jsx("p",{children:"Difficulté"}),l.jsx("p",{children:c})]}),l.jsxs(p5,{$mainBgColor:t,$fontColor:a,$color:r,children:[l.jsx("p",{children:"Nombre de Kanji "}),l.jsx("p",{children:s})]}),l.jsxs(f5,{$mainBgColor:t,$fontColor:a,$color:r,children:[l.jsx("p",{children:"Mode de jeu"}),l.jsx("p",{children:o})]}),l.jsx(m5,{$mainBgColor:t,$fontColor:a,$color:r,children:w&&l.jsxs("div",{children:[l.jsx("h3",{children:w.kanji||w.Dakuten||w.Handakuten||w.hiragana||w.Hiragana||w.Katakana||w.Kanji}),l.jsxs("div",{children:[w.Romaji&&l.jsxs("p",{children:[l.jsx("span",{children:"Romaji "})," ",w.Romaji]}),w.francais&&l.jsxs("p",{children:[l.jsx("span",{children:"Francais "})," ",w.francais]}),w.hiragana&&l.jsxs("p",{children:[l.jsx("span",{children:"Hiragana "})," ",w.hiragana]}),w.OnPrincipalReading&&l.jsxs("p",{children:[l.jsx("span",{children:"On "})," ",w.OnPrincipalReading]}),w.KunPrincipalReading&&l.jsxs("p",{children:[l.jsx("span",{children:"Kun "})," ",w.KunPrincipalReading]}),w.Meaning&&l.jsxs("p",{children:[l.jsx("span",{children:"Francais "})," ",w.Meaning]})]})]})}),l.jsx(h5,{$mainBgColor:t,$fontColor:a,$color:r,children:l.jsx("div",{children:g.length>0?g.filter(Boolean).map((f,R)=>l.jsx("p",{onMouseEnter:()=>y(f),children:f.kanji||(f.Nom==="Handakuten"?f.Handakuten:f.Nom==="Dakuten"?f.Dakuten:f.hiragana||f.Hiragana||f.Katakana||f.Kanji)},R)):l.jsx("p",{children:"pas de faute"})})}),l.jsxs(v5,{$mainBgColor:t,$fontColor:a,$color:r,children:[l.jsx("p",{children:"Erreur"}),l.jsx("p",{children:h})]}),l.jsx(w5,{$mainBgColor:t,$fontColor:a,$color:r,children:l.jsxs("p",{children:[p===!1?v:u,l.jsx("span",{children:"s"})]})}),l.jsx(R5,{$mainBgColor:t,$fontColor:a,$color:r,$bgColor:i,children:l.jsx("div",{})})]}),l.jsxs(j5,{$mainBgColor:t,$fontColor:a,$color:r,$bgColor:i,children:[l.jsxs("button",{onClick:e,children:[" ",l.jsx(qc,{color:r,width:m,height:m,children:" "})]}),l.jsx("button",{onClick:()=>{e(),n(-1)},children:"Terminer"})]})]})}Om.propTypes={onReload:M.func.isRequired};const y5=j.div`
    display: flex;
    flex-direction: column;
    align-items: center;
    width: 100%;
...
`;function T5(){const{bgColor:e}=P(n=>n.mode);return l.jsxs(K5,{$bgColor:e,children:[l.jsx(C5,{}),l.jsxs(b5,{children:[l.jsx(Wu,{}),l.jsx(Wu,{})]})]})}const $5=j.div`
    display: flex;
    justify-content: center;
    align-items: center;
    gap: 0.5vw;
...
`;function S5(){const{bgColor:e,fontColor:n,mainBgColor:i}=P(s=>s.mode),a=P(s=>s.exercice.totalfaute),t=P(s=>s.exercice.totalreussite),r=P(s=>s.parametersExercice.exerciceNumber),o=t+a;return l.jsxs($5,{$mainBgColor:i,$bgColor:e,$fontColor:n,children:[l.jsx("p",{children:t}),l.jsxs("p",{children:[o,"/",r]}),l.jsx("p",{children:a})]})}function O5(){return l.jsx("div",{})}const N5=j.div`
    display: flex;
    align-items: center;
...
`;function M5(){return l.jsxs(N5,{children:[l.jsx(S5,{}),location.pathname==="/Exercices/Katakana"||location.pathname==="/Exercices/Hiragana"||location.pathname==="/Exercices/Kanji"&&l.jsx(O5,{})]})}const E5=j.div`
    display: flex;
    align-items: center;
    flex-direction: column;
    justify-content: center;
...
`;function W5(){const e=P(i=>i.mode),{bgColor:n}=P(i=>i.mode);return l.jsxs(I5,{children:[l.jsx(F5,{}),l.jsx(V5,{$bgColor:n,to:"/color",children:l.jsx("img",{src:e.mode==="light"?A5:B5})})]})}const U5=()=>{const{mainBgColor:e}=P(n=>n.mode);return K.useEffect(()=>{document.body.style.backgroundColor=e},[e]),null},Q5=j.div`
    display: flex;
    flex-direction: column;
    align-items: center;
    justify-content: center;
...
`,q5=()=>{const{fontColor:e}=P(i=>i.mode),{color:n}=P(i=>i.color);return l.jsxs(Q5,{$fontColor:e,$color:n,className:"error404-container",children:[l.jsx("h1",{children:"404"}),l.jsx("p",{children:"Je crois que tu t'es perdu là"}),l.jsx(mi,{to:"/",children:"Retour à l'accueil"})]})};function Z5(){const e=ge(),n=!e.pathname.startsWith("/choisir-ses/")&&!e.pathname.startsWith("/Exercices/"),i=!e.pathname.startsWith("/Exercices/");return l.jsxs("div",{className:"App",children:[n&&l.jsx(r5,{}),i&&l.jsx(U5,{}),i&&l.jsx(W5,{}),l.jsxs(Uv,{children:[l.jsx(an,{path:"/",element:l.jsx(fR,{})}),l.jsx(an,{path:"/kanji",element:l.jsx(Mj,{})}),l.jsx(an,{path:"/vocabulaire",element:l.jsx(Hj,{})}),l.jsx(an,{path:"/katakana",element:l.jsx(zj,{})}),l.jsx(an,{path:"/hiragana",element:l.jsx(Fj,{})}),l.jsx(an,{path:"/nombres",element:l.jsx(Bj,{})}),l.jsx(an,{path:"/dictionnaire/*",element:l.jsx(zy,{})}),l.jsx(an,{path:"/choisir-ses/*",element:l.jsx(Zy,{})}),l.jsx(an,{path:"/color",element:l.jsx(Bw,{})}),l.jsx(an,{path:"/exercices/*",element:l.jsx(H5,{})}),l.jsx(an,{path:"*",element:l.jsx(q5,{})})]})]})}const Y5="/Nihongo-V2/#",G5=Ll.createRoot(document.getElementById("root"));G5.render(l.jsx(P1,{store:D2,children:l.jsx(e1,{basename:Y5,children:l.jsx(Z5,{})})}));
