...
`;function Bt(){const{bgColor:e,fontColor:n,mainBgColor:i}=P(u=>u.mode),{color:a}=P(u=>u.color),t=localStorage.getItem("mode")||"light",r=window.innerWidth<=560?"10vw":"3vw",o=He(),s=ce(),c=u=>{window.scrollTo({top:document.querySelector("#exercice").offsetTop,behavior:"smooth"});const p={"Premier pas":{difficulté:"Débutant",number:10,typeDeKana:"normal",modeDeJeu:"N5"},Découverte:{difficulté:"Débutant",number:20,typeDeKana:"normal",modeDeJeu:"N5"},"Développement Avancé":{difficulté:"Intermédiaire",number:20,typeDeKana:"tout",modeDeJeu:"Aléatoire"},"Mises à Jour":{difficulté:"Confirmé",number:30,typeDeKana:"tout",modeDeJeu:"Aléatoire"}}[u];p&&(o(jm(p.difficulté)),o(ym(p.number)),o(Qc(p.typeDeKana)),s.pathname==="/Hiragana"||s.pathname==="/Nihongo-V2/Hiragana"||s.pathname==="/Katakana"||s.pathname==="/Nihongo-V2/Katakana"?o(lt("Aléatoire")):o(lt(p.modeDeJeu)))};return console.log(s.pathname),l.jsxs(ty,{$bgColor:e,children:[l.jsxs(ry,{$fontColor:n,$mainBgColor:i,$color:a,children:[l.jsx("p",{children:"Prereglage Exercices"}),l.jsxs(oy,{children:[l.jsxs(ly,{$fontColor:n,$mainBgColor:i,$color:a,children:[l.jsxs("div",{children:[l.jsx("button",{children:l.jsx(Cm,{width:r,height:r,color:a,mainColor:i})}),l.jsx("button",{children:l.jsx("img",{src:t==="light"?Lm:Io})})]}),l.jsx("button",{children:l.jsx("span",{children:"Créer"})})]}),l.jsxs(sy,{$fontColor:n,$mainBgColor:i,$color:a,children:[l.jsx("div",{}),l.jsx("div",{})]})]})]}),l.jsxs(cy,{children:[l.jsxs(pr,{onClick:()=>c("Premier pas"),$fontColor:n,$mainBgColor:i,$color:a,children:[l.jsx("h3",{children:"Premier pas"}),l.jsx("p",{children:"Parfait pour découvrir"}),l.jsx("img",{src:ey})]}),l.jsxs(pr,{onClick:()=>c("Découverte"),$fontColor:n,$mainBgColor:i,$color:a,children:[l.jsx("h3",{children:"Découverte"}),l.jsx("p",{children:"Parfait pour en apprendre plus"}),l.jsx("img",{src:ny})]}),l.jsxs(pr,{onClick:()=>c("Développement Avancé"),$fontColor:n,$mainBgColor:i,$color:a,children:[l.jsx("h3",{children:"Développement Avancé"}),l.jsx("p",{children:"Parfait pour développer ses compétences"}),l.jsx("img",{src:iy})]}),l.jsxs(pr,{onClick:()=>c("Mises à Jour"),$fontColor:n,$mainBgColor:i,$color:a,children:[l.jsx("h3",{children:"Mises à Jour"}),l.jsx("p",{children:"Parfait pour continue à se perfectionner"}),l.jsx("img",{src:ay})]})]})]})}const dy=j.header`
    display: flex;
    flex-direction: column;
    gap: 1vw;
    margin-left: 3vw;
