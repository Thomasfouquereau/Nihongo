 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var yf=K,kf=Symbol.for("react.element"),Cf=Symbol.for("react.fragment"),Pf=Object.prototype.hasOwnProperty,Lf=yf.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,bf={key:!0,ref:!0,__self:!0,__source:!0};function kg(e,n,i){var a,t={},r=null,l=null;i!==void 0&&(r=""+i),n.key!==void 0&&(r=""+n.key),n.ref!==void 0&&(l=n.ref);for(a in n)Pf.call(n,a)&&!bf.hasOwnProperty(a)&&(t[a]=n[a]);if(e&&e.defaultProps)for(a in n=e.defaultProps,n)t[a]===void 0&&(t[a]=n[a]);return{$$typeof:kf,type:e,key:r,ref:l,props:t,_owner:Lf.current}}vo.Fragment=Cf;vo.jsx=kg;vo.jsxs=kg;pg.exports=vo;var o=pg.exports,Jl={},Cg={exports:{}},tn={},Pg={exports:{}},Lg={};/**
 * @license React
...
`;function ky(){const{bgColor:e,fontColor:n,mainBgColor:i}=y(s=>s.mode),{color:a}=y(s=>s.color),t=localStorage.getItem("mode")||"light",r=localStorage.getItem("userLvL")||0,l=localStorage.getItem("userName");return o.jsxs(Ry,{to:"/Profile",$mainBgColor:i,$fontColor:n,children:[o.jsx(xy,{$bgColor:e,children:o.jsx("img",{src:t==="light"?jy:wy,alt:"Profile"})}),o.jsxs(yy,{$color:a,children:[o.jsx("p",{children:l}),o.jsxs("p",{children:[o.jsx("span",{children:"lvl"}),r]})]})]})}const Cy=w.div`
    top:0;
    left: 0;
    z-index: 101;
    &::before{
