...
const LvlUpMessageContainer = styled.div`
...
export default function LvlUpMessage() {
    ...
    return (
        <LvlUpMessageContainer $mainBgColor={mainBgColor} $color={color} $bgColor={bgColor}  $display={displayMessage} >
            <span>lvl up</span>
            <p>lvl {lvl}</p>
        </LvlUpMessageContainer>
    );
}